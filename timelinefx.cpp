...
#define tfxNoise2dPermMOD12LoopUnroll(i)    \
    ...
    gi2.a[i] = tfx_perm_mod12[tfx_permutation_table[ii.a[i] + 1 + tfx_permutation_table[jj.a[i] + 1]]];    
...
#define tfxNoise3dPermModLoopUnroll(i) \
	...
	tfxWideFloat tfx__simd_noise_3d(const tfxWideFloat x4, const tfxWideFloat y4, const tfxWideFloat z4) {
		...
		tfxWideFloat s4 = tfxWideMul(tfxWideAdd(x4, tfxWideAdd(y4, z4)), tfxF3_4.m);
		tfxWideFloat x4_s4 = tfxWideAdd(x4, s4);
		tfxWideFloat y4_s4 = tfxWideAdd(y4, s4);
		tfxWideFloat z4_s4 = tfxWideAdd(z4, s4);
		tfxWideFloat i = tfxWideFloor(x4_s4);
		tfxWideFloat j = tfxWideFloor(y4_s4);
		tfxWideFloat k = tfxWideFloor(z4_s4);
		tfxWideFloat t = tfxWideAdd(i, j);
		t = tfxWideAdd(t, k);
		t = tfxWideMul(t, tfxG3_4.m);

		tfxWideFloat X0 = tfxWideSub(i, t); // Unskew the cell origin back to (v1.x,v1.y,v1.z) space
		tfxWideFloat Y0 = tfxWideSub(j, t);
		tfxWideFloat Z0 = tfxWideSub(k, t);
		tfxWideFloat x0 = tfxWideSub(x4, X0); // The v1.x,v1.y,v1.z distances from the cell origin
		tfxWideFloat y0 = tfxWideSub(y4, Y0);
		tfxWideFloat z0 = tfxWideSub(z4, Z0);

		// For the 3D case, the simplex shape is a slightly irregular tetrahedron.
		// Determine which simplex we are in.
		tfxWideArrayi i1, i2, j1, j2, k1, k2;

		i1.m = tfxWideAndi(tfxONE.m, tfxWideAndi(tfxWideCasti(tfxWideGreaterEqual(x0, y0)), tfxWideCasti(tfxWideGreaterEqual(x0, z0))));
		j1.m = tfxWideAndi(tfxONE.m, tfxWideAndi(tfxWideCasti(tfxWideGreater(y0, x0)), tfxWideCasti(tfxWideGreaterEqual(y0, z0))));
		k1.m = tfxWideAndi(tfxONE.m, tfxWideAndi(tfxWideCasti(tfxWideGreater(z0, x0)), tfxWideCasti(tfxWideGreater(z0, y0))));

		//for i2
		tfxWideInt yx_xz = tfxWideAndi(tfxWideCasti(tfxWideGreaterEqual(x0, y0)), tfxWideCasti(tfxWideLess(x0, z0)));
		tfxWideInt zx_xy = tfxWideAndi(tfxWideCasti(tfxWideGreaterEqual(x0, z0)), tfxWideCasti(tfxWideLess(x0, y0)));

		//for j2
		tfxWideInt xy_yz = tfxWideAndi(tfxWideCasti(tfxWideLess(x0, y0)), tfxWideCasti(tfxWideLess(y0, z0)));
		tfxWideInt zy_yx = tfxWideAndi(tfxWideCasti(tfxWideGreaterEqual(y0, z0)), tfxWideCasti(tfxWideGreaterEqual(x0, y0)));

		//for k2
		tfxWideInt yz_zx = tfxWideAndi(tfxWideCasti(tfxWideLess(y0, z0)), tfxWideCasti(tfxWideGreaterEqual(x0, z0)));
		tfxWideInt xz_zy = tfxWideAndi(tfxWideCasti(tfxWideLess(x0, z0)), tfxWideCasti(tfxWideGreaterEqual(y0, z0)));

		i2.m = tfxWideAndi(tfxONE.m, tfxWideOri(i1.m, tfxWideOri(yx_xz, zx_xy)));
		j2.m = tfxWideAndi(tfxONE.m, tfxWideOri(j1.m, tfxWideOri(xy_yz, zy_yx)));
		k2.m = tfxWideAndi(tfxONE.m, tfxWideOri(k1.m, tfxWideOri(yz_zx, xz_zy)));

		tfxWideFloat x1 = tfxWideAdd(tfxWideSub(x0, tfxWideConvert(i1.m)), tfxG3_4.m);
		tfxWideFloat y1 = tfxWideAdd(tfxWideSub(y0, tfxWideConvert(j1.m)), tfxG3_4.m);
		tfxWideFloat z1 = tfxWideAdd(tfxWideSub(z0, tfxWideConvert(k1.m)), tfxG3_4.m);
		tfxWideFloat x2 = tfxWideAdd(tfxWideSub(x0, tfxWideConvert(i2.m)), tfxG32_4.m);
		tfxWideFloat y2 = tfxWideAdd(tfxWideSub(y0, tfxWideConvert(j2.m)), tfxG32_4.m);
		tfxWideFloat z2 = tfxWideAdd(tfxWideSub(z0, tfxWideConvert(k2.m)), tfxG32_4.m);
		tfxWideFloat x3 = tfxWideAdd(tfxWideSub(x0, tfxONEF.m), tfxG33_4.m);
		tfxWideFloat y3 = tfxWideAdd(tfxWideSub(y0, tfxONEF.m), tfxG33_4.m);
		tfxWideFloat z3 = tfxWideAdd(tfxWideSub(z0, tfxONEF.m), tfxG33_4.m);
		...
		jj.m = tfxWideAndi(tfxWideConverti(j), tfxFF.m);
		tfxWideArrayi kk;
		kk.m = tfxWideAndi(tfxWideConverti(k), tfxFF.m);
		tfxWideArrayi gi0, gi1, gi2, gi3;
...
#ifdef tfxUSEAVX
		tfxNoise3dPermModLoopUnroll(4);
		tfxNoise3dPermModLoopUnroll(5);
		tfxNoise3dPermModLoopUnroll(6);
		tfxNoise3dPermModLoopUnroll(7);
#endif

		tfxWideFloat t0 = tfxWideSub(tfxWideSub(tfxWideSub(tfxPSIX.m, tfxWideMul(x0, x0)), tfxWideMul(y0, y0)), tfxWideMul(z0, z0));
		tfxWideFloat t1 = tfxWideSub(tfxWideSub(tfxWideSub(tfxPSIX.m, tfxWideMul(x1, x1)), tfxWideMul(y1, y1)), tfxWideMul(z1, z1));
		tfxWideFloat t2 = tfxWideSub(tfxWideSub(tfxWideSub(tfxPSIX.m, tfxWideMul(x2, x2)), tfxWideMul(y2, y2)), tfxWideMul(z2, z2));
		tfxWideFloat t3 = tfxWideSub(tfxWideSub(tfxWideSub(tfxPSIX.m, tfxWideMul(x3, x3)), tfxWideMul(y3, y3)), tfxWideMul(z3, z3));

		tfxWideFloat t0q = tfxWideMul(t0, t0);
		t0q = tfxWideMul(t0q, t0q);
		tfxWideFloat t1q = tfxWideMul(t1, t1);
		t1q = tfxWideMul(t1q, t1q);
		tfxWideFloat t2q = tfxWideMul(t2, t2);
		t2q = tfxWideMul(t2q, t2q);
		tfxWideFloat t3q = tfxWideMul(t3, t3);
		t3q = tfxWideMul(t3q, t3q);

		tfxWideArray gi0x, gi0y, gi0z, gi1x, gi1y, gi1z, gi2x, gi2y, gi2z, gi3x, gi3y, gi3z;
...
#ifdef tfxUSEAVX
		tfxNoise3dGradientLoopUnroll(4)
		tfxNoise3dGradientLoopUnroll(5)
		tfxNoise3dGradientLoopUnroll(6)
		tfxNoise3dGradientLoopUnroll(7)
#endif

		tfxWideFloat n0 = tfxWideMul(t0q, tfx__wide_dp_xyz(gi0x.m, gi0y.m, gi0z.m, x0, y0, z0));
		tfxWideFloat n1 = tfxWideMul(t1q, tfx__wide_dp_xyz(gi1x.m, gi1y.m, gi1z.m, x1, y1, z1));
...
void tfx__wide_euler_to_packed_quaternion(tfxWideFloat pitch, tfxWideFloat yaw, tfxWideFloat roll, tfxWideInt *out_xy, tfxWideInt *out_zw) {
	...
	tfxWideSinCos(tfxWideMul(pitch, half), &sp, &cp);
	tfxWideSinCos(tfxWideMul(yaw, half), &sy, &cy);
	tfxWideSinCos(tfxWideMul(roll, half), &sr, &cr);
	...
	tfxWideFloat w = tfxWideMulAdd(cr, cpcy, tfxWideMul(sr, spsy));
	tfxWideFloat z = tfxWideMulSub(sr, cpcy, tfxWideMul(cr, spsy));
...
tfxWideInt tfx__wide_pack8bitunorm_xyz(tfxWideFloat const &v_x, tfxWideFloat const &v_y, tfxWideFloat const &v_z) {
	tfxWideFloat w255 = tfxWideSetSingle(255.f);
	tfxWideInt bits8 = tfxWideSetSinglei(0xFF);
	tfxWideInt converted_x = tfxWideConverti(tfxWideMul(v_x, w255));
	converted_x = tfxWideAndi(converted_x, bits8);
	tfxWideInt converted_y = tfxWideConverti(tfxWideMul(v_y, w255));
	converted_y = tfxWideAndi(converted_y, bits8);
	converted_y = tfxWideShiftLeft(converted_y, 8);
	tfxWideInt converted_z = tfxWideConverti(tfxWideMul(v_z, w255));
...
tfx_package tfx__create_package(const char *file_path) {
	...
	package->file_path.SetText(file_path);
...
bool tfx__validate_package(tfx_package package) {
	...
	FILE *file = tfx__open_file(package->file_path.data, "rb");
	if (!file) {
		return false;
	}
...
void tfx__copy_stream(tfx_stream dst, tfx_stream src) {
	TFX_ASSERT(dst);	//Stream doesn't exist!
	dst->Free();
	dst->Resize(src->size);
...
void tfx__read_entire_file(const char *file_name, tfx_stream buffer, bool terminate) {
...
bool tfx__save_package_disk(tfx_package package) {
	...
	FILE *file = tfx__open_file(package->file_path.data, "wb");
	if (!file)
		return false;
...
tfxErrorFlags tfx__load_package_file(const char *file_name, tfx_package package) {
	...
	for (int i = 0; i != package->inventory.entry_count; ++i) {
		...
		TFX_ASSERT(file_name_size <= 512);	//file name of package entry is greater than max of 512, maybe the file is corrupt?
	...
	package->file_path.SetText(file_name);
...
bool tfx__is_finite_emitter(tfx_effect_descriptor emitter) {
	if (emitter->state_properties.shared_flags & tfxSharedEmitterPropertyFlags_single && tfx__get_shared_emitter_properties(emitter)->single_shot_limit == 0) {
		return false;
	}
	float qty = tfx__get_graph_last_value(tfx__get_descriptor_graph(emitter, tfxEmitter_base_amount_index)) + tfx__get_graph_last_value(tfx__get_descriptor_graph(emitter, tfxEmitter_variation_amount_index));
	if (!(emitter->state_properties.shared_flags & tfxSharedEmitterPropertyFlags_single) && qty > 0) {
		return false;
	}
	return true;
}
...
bool tfx__is_ordered_effect_state(tfx_effect_state_t *effect) {
	return (effect->effect_flags & tfxEffectPropertyFlags_is_ordered) > 0;
}
...
void tfx__update_source_emitter_flags(tfx_effect_descriptor effect) {
	...
	for(tfx_effect_descriptor child : effect->children) {
		child->state_properties.shared_flags &= ~tfxSharedEmitterPropertyFlags_spawn_location_source;
	...
	while(!stack.empty()) {
		...
		if (emitter) {
			emitter->state_properties.shared_flags |= tfxSharedEmitterPropertyFlags_spawn_location_source;
		}
	}
	stack.free();
}
...
tfx_effect_descriptor tfx__add_emitter_to_effect(tfx_effect_descriptor effect, tfx_effect_descriptor emitter, tfx_effect_descriptor_type type) {
	...
	TFX_ASSERT(emitter->name.Length());                //Emitter must have a name so that a hash can be generated
	emitter->type = type;
...
tfx_effect_descriptor tfx__add_new_ribbon_to_effect(tfx_effect_descriptor effect, tfx_str64_t *name) {
	...
	ribbon->state_properties.transform_index = tfx__add_library_transform_graphs(ribbon->library);
	ribbon->state_properties.graph_list_index = tfx__add_library_graphs(ribbon->library, tfxRibbonType);
	tfx__reset_ribbon_graphs(ribbon);
	tfx__reset_transform_graphs(ribbon);
	ribbon->name = *name;
	ribbon->uid = ++effect->library->uid;
	effect->children.push_back(ribbon);
	tfx__update_library_effect_paths(effect->library);
...
tfx_effect_descriptor tfx__add_effect_to_emitter(tfx_effect_descriptor emitter, tfx_effect_descriptor effect) {
	TFX_ASSERT_HANDLE(emitter);	//Not a valid emitter
	TFX_ASSERT_HANDLE(effect);	//Not a valid effect
	TFX_ASSERT(effect->name.Length());                //Effect must have a name so that a hash can be generated
	effect->type = tfx_effect_descriptor_type::tfxEffectType;
	effect->library = emitter->library;
	effect->parent = emitter;
	effect->uid = ++emitter->library->uid;
	emitter->children.push_back(effect);
...
void tfx__ribbon_data_set_captured_indexes(tfx_sprite_data_t *sprite_data) {
	tfx_ribbon_t *instance = sprite_data->compressed_ribbons.ribbon_instance;
	tfx_ribbon_data_soa_t &c_ribbons = sprite_data->compressed_ribbons;
	tfxU32 frame_count = sprite_data->compressed.frame_count;
	for (tfxU32 current_frame = 0; current_frame < frame_count; ++current_frame) {
		tfxU32 previous_frame = current_frame == 0 ? frame_count - 1 : current_frame - 1;
		tfx_ribbon_frame_meta_t &current_meta = sprite_data->compressed.ribbon_frame_meta[current_frame];
		tfx_ribbon_frame_meta_t &previous_meta = sprite_data->compressed.ribbon_frame_meta[previous_frame];
		for (tfxU32 i = current_meta.index_offset; i < current_meta.index_offset + current_meta.ribbon_count; ++i) {
			if (instance[i].captured_index != tfxINVALID) {
				int age_diff = 0x7FFFFFFF;
				instance[i].captured_index = tfxINVALID;  //Reset, we'll find the real one below
				for (tfxU32 j = previous_meta.index_offset; j < previous_meta.index_offset + previous_meta.ribbon_count; ++j) {
					if (c_ribbons.uid[j].uid == c_ribbons.uid[i].uid) {
						int diff = (int)c_ribbons.uid[i].age - (int)c_ribbons.uid[j].age;
						if (diff < 0) continue;
						if (diff < age_diff) {
							age_diff = diff;
        ...
        for (int i = sprite_data->compressed.frame_meta[frame_pair[0]].index_offset[layer]; i != sprite_data->compressed.frame_meta[frame_pair[0]].index_offset[layer] + sprite_data->compressed.frame_meta[frame_pair[0]].sprite_count[layer]; ++i) {
            if (instance[i].captured_index != tfxINVALID) {
                ...
                for (int j = sprite_data->compressed.frame_meta[frame_pair[1]].index_offset[layer]; j != sprite_data->compressed.frame_meta[frame_pair[1]].index_offset[layer] + sprite_data->compressed.frame_meta[frame_pair[1]].sprite_count[layer]; ++j) {
                    //Find particles of the same uid
                    if (c_sprites.uid[j].uid == c_sprites.uid[i].uid) {
                        int diff = (int)c_sprites.uid[i].age - (int)c_sprites.uid[j].age;
                        if (diff < 0) continue;
...
void tfx__reset_effect_graphs(tfx_effect_descriptor effect, bool add_node) {
	...
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_amount_index], 1.f, tfxGlobalPercentPreset, add_node); library->graphs[graph_list_index].graphs[tfxEffect_global_amount_index].type = tfxGlobal_amount;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_velocity_index], 1.f, tfxGlobalPercentPreset, add_node); library->graphs[graph_list_index].graphs[tfxEffect_global_velocity_index].type = tfxGlobal_velocity;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_noise_index], 1.f, tfxGlobalPercentPreset, add_node); library->graphs[graph_list_index].graphs[tfxEffect_global_noise_index].type = tfxGlobal_noise;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_width_index], 1.f, tfxGlobalPercentPreset, add_node); library->graphs[graph_list_index].graphs[tfxEffect_global_width_index].type = tfxGlobal_width;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_height_index], 1.f, tfxGlobalPercentPreset, add_node); library->graphs[graph_list_index].graphs[tfxEffect_global_height_index].type = tfxGlobal_height;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_weight_index], 1.f, tfxGlobalPercentPreset, add_node); library->graphs[graph_list_index].graphs[tfxEffect_global_weight_index].type = tfxGlobal_weight;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_roll_spin_index], 1.f, tfxGlobalPercentPresetSigned, add_node); library->graphs[graph_list_index].graphs[tfxEffect_global_roll_spin_index].type = tfxGlobal_roll_spin;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_pitch_spin_index], 1.f, tfxGlobalPercentPresetSigned, add_node); library->graphs[graph_list_index].graphs[tfxEffect_global_pitch_spin_index].type = tfxGlobal_pitch_spin;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_yaw_spin_index], 1.f, tfxGlobalPercentPresetSigned, add_node); library->graphs[graph_list_index].graphs[tfxEffect_global_yaw_spin_index].type = tfxGlobal_yaw_spin;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_stretch_index], 1.f, tfxGlobalPercentPreset, add_node); library->graphs[graph_list_index].graphs[tfxEffect_global_stretch_index].type = tfxGlobal_stretch;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_overal_scale_index], 1.f, tfxGlobalPercentPreset, add_node); library->graphs[graph_list_index].graphs[tfxEffect_global_overal_scale_index].type = tfxGlobal_overal_scale;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_intensity_index], 1.f, tfxGlobalPercentPreset, add_node); library->graphs[graph_list_index].graphs[tfxEffect_global_intensity_index].type = tfxGlobal_intensity;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_splatter_index], 1.f, tfxGlobalPercentPreset, add_node); library->graphs[graph_list_index].graphs[tfxEffect_global_splatter_index].type = tfxGlobal_splatter;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_emitter_width_index], 1.f, tfxGlobalPercentPreset, add_node); library->graphs[graph_list_index].graphs[tfxEffect_global_emitter_width_index].type = tfxGlobal_emitter_width;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_emitter_height_index], 1.f, tfxGlobalPercentPreset, add_node); library->graphs[graph_list_index].graphs[tfxEffect_global_emitter_height_index].type = tfxGlobal_emitter_height;
...
void tfx__reset_transform_graphs(tfx_effect_descriptor effect, bool add_node) {
	tfx_library library = effect->library;
	tfxU32 graph_list_index = effect->state_properties.transform_index;
...
void tfx__reset_emitter_graphs(tfx_effect_descriptor effect, bool add_node) {
	tfx_library library = effect->library;
	tfxU32 graph_list_index = effect->state_properties.graph_list_index;
	float default_dimensions = 0.1f;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_base_life_index], 1000.f, tfxLifePreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_base_life_index].type = tfxBase_life;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_base_amount_index], 1.f, tfxAmountPreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_base_amount_index].type = tfxBase_amount;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_base_velocity_index], 0.f, tfxVelocityPreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_base_velocity_index].type = tfxBase_velocity;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_base_width_index], default_dimensions, tfxDimensionsPreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_base_width_index].type = tfxBase_width;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_base_height_index], default_dimensions, tfxDimensionsPreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_base_height_index].type = tfxBase_height;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_base_weight_index], 0.f, tfxWeightPreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_base_weight_index].type = tfxBase_weight;
	...
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_property_splatter_index], 0.f, tfxDimensionsPreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_property_splatter_index].type = tfxProperty_splatter;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_property_width_index], 1.f, tfxDimensionsPreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_property_width_index].type = tfxProperty_emitter_width;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_property_height_index], 1.f, tfxDimensionsPreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_property_height_index].type = tfxProperty_emitter_height;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_property_depth_index], 1.f, tfxDimensionsPreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_property_depth_index].type = tfxProperty_emitter_depth;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_property_extrusion_index], 0.f, tfxDimensionsPreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_property_extrusion_index].type = tfxProperty_extrusion;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_property_arc_size_index], tfx_DegreesToRadians(360.f), tfxArcPreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_property_arc_size_index].type = tfxProperty_arc_size;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_property_arc_offset_index], 0.f, tfxArcPreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_property_arc_offset_index].type = tfxProperty_arc_offset;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_variation_life_index], 0.f, tfxLifePreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_variation_life_index].type = tfxVariation_life;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_variation_amount_index], 0.f, tfxAmountPreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_variation_amount_index].type = tfxVariation_amount;
	...
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_weight_index], 1.f, tfxWeightOvertimePreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_overtime_weight_index].type = tfxOvertime_weight;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_roll_spin_index], 0.f, tfxSpinOvertimePreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_overtime_roll_spin_index].type = tfxOvertime_roll_spin;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_pitch_spin_index], 0.f, tfxSpinOvertimePreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_overtime_pitch_spin_index].type = tfxOvertime_pitch_spin;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_yaw_spin_index], 0.f, tfxSpinOvertimePreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_overtime_yaw_spin_index].type = tfxOvertime_yaw_spin;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_stretch_index], 0.f, tfxPercentOvertime, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_overtime_stretch_index].type = tfxOvertime_stretch;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_red_index], 1.f, tfxColorPreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_overtime_red_index].type = tfxOvertime_red;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_green_index], 1.f, tfxColorPreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_overtime_green_index].type = tfxOvertime_green;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_blue_index], 1.f, tfxColorPreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_overtime_blue_index].type = tfxOvertime_blue;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_blendfactor_index], 0.f, tfxOpacityOvertimePreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_overtime_blendfactor_index].type = tfxOvertime_blendfactor;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_intensity_index], 1.f, tfxIntensityOvertimePreset, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_overtime_intensity_index].type = tfxOvertime_intensity;
	...
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_noise_resolution_index], 1.f, tfxPercentOvertime, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_overtime_noise_resolution_index].type = tfxOvertime_noise_resolution;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_motion_randomness_index], 0.f, tfxPercentOvertime, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_overtime_motion_randomness_index].type = tfxOvertime_motion_randomness;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_factor_life_index], 1.f, tfxPercentOvertime, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_factor_life_index].type = tfxFactor_life;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_factor_velocity_index], 1.f, tfxPercentOvertime, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_factor_velocity_index].type = tfxFactor_velocity;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_factor_size_index], 1.f, tfxPercentOvertime, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_factor_size_index].type = tfxFactor_size;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_factor_intensity_index], 1.f, tfxPercentOvertime, add_node); library->graphs[graph_list_index].graphs[tfxEmitter_factor_intensity_index].type = tfxFactor_intensity;
}

void tfx__reset_ribbon_graphs(tfx_effect_descriptor effect, bool add_node) {
	tfx_library library = effect->library;
	tfxU32 graph_list_index = effect->state_properties.graph_list_index;
	float default_dimensions = 0.2f;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxRibbon_base_life_index], 1000.f, tfxLifePreset, add_node); library->graphs[graph_list_index].graphs[tfxRibbon_base_life_index].type = tfxBase_life;
	...
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxRibbon_variation_life_index], 0.f, tfxLifePreset, add_node); library->graphs[graph_list_index].graphs[tfxRibbon_variation_life_index].type = tfxVariation_life;
	...
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxRibbon_overtime_blendfactor_index], 0.f, tfxOpacityOvertimePreset, add_node); library->graphs[graph_list_index].graphs[tfxRibbon_overtime_blendfactor_index].type = tfxOvertime_blendfactor;
	tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxRibbon_overtime_intensity_index], 1.f, tfxIntensityOvertimePreset, add_node); library->graphs[graph_list_index].graphs[tfxRibbon_overtime_intensity_index].type = tfxOvertime_intensity;
...
void tfx__initialise_unitialised_graphs(tfx_effect_descriptor effect) {
	...
	if (library->graphs[effect->state_properties.transform_index].graphs[tfxTransform_roll_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[effect->state_properties.transform_index].graphs[tfxTransform_roll_index], 0.f, tfxAnglePreset);
	if (library->graphs[effect->state_properties.transform_index].graphs[tfxTransform_pitch_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[effect->state_properties.transform_index].graphs[tfxTransform_pitch_index], 0.f, tfxAnglePreset);
	if (library->graphs[effect->state_properties.transform_index].graphs[tfxTransform_yaw_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[effect->state_properties.transform_index].graphs[tfxTransform_yaw_index], 0.f, tfxAnglePreset);
	...
	if (effect->type == tfxEffectType) {
		...
		if (library->graphs[graph_list_index].graphs[tfxEffect_global_amount_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_amount_index], 1.f, tfxGlobalPercentPreset);
		if (library->graphs[graph_list_index].graphs[tfxEffect_global_velocity_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_velocity_index], 1.f, tfxGlobalPercentPreset);
		if (library->graphs[graph_list_index].graphs[tfxEffect_global_noise_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_noise_index], 1.f, tfxGlobalPercentPreset);
		if (library->graphs[graph_list_index].graphs[tfxEffect_global_width_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_width_index], 1.f, tfxGlobalPercentPreset);
		if (library->graphs[graph_list_index].graphs[tfxEffect_global_height_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_height_index], 1.f, tfxGlobalPercentPreset);
		if (library->graphs[graph_list_index].graphs[tfxEffect_global_weight_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_weight_index], 1.f, tfxGlobalPercentPreset);
		if (library->graphs[graph_list_index].graphs[tfxEffect_global_roll_spin_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_roll_spin_index], 1.f, tfxGlobalPercentPresetSigned);
		if (library->graphs[graph_list_index].graphs[tfxEffect_global_pitch_spin_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_pitch_spin_index], 1.f, tfxGlobalPercentPresetSigned);
		if (library->graphs[graph_list_index].graphs[tfxEffect_global_yaw_spin_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_yaw_spin_index], 1.f, tfxGlobalPercentPresetSigned);
		if (library->graphs[graph_list_index].graphs[tfxEffect_global_stretch_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_stretch_index], 1.f, tfxGlobalPercentPreset);
		if (library->graphs[graph_list_index].graphs[tfxEffect_global_overal_scale_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_overal_scale_index], 1.f, tfxGlobalPercentPreset);
		if (library->graphs[graph_list_index].graphs[tfxEffect_global_intensity_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_intensity_index], 1.f, tfxGlobalPercentPreset);
		if (library->graphs[graph_list_index].graphs[tfxEffect_global_splatter_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_splatter_index], 1.f, tfxGlobalPercentPreset);
		if (library->graphs[graph_list_index].graphs[tfxEffect_global_emitter_width_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_emitter_width_index], 1.f, tfxGlobalPercentPreset);
		if (library->graphs[graph_list_index].graphs[tfxEffect_global_emitter_height_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_emitter_height_index], 1.f, tfxGlobalPercentPreset);
		if (library->graphs[graph_list_index].graphs[tfxEffect_global_emitter_depth_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEffect_global_emitter_depth_index], 1.f, tfxGlobalPercentPreset);
	}

	if (effect->type == tfxEmitterType) {
		float default_dimensions = 0.1f;
		if (library->graphs[graph_list_index].graphs[tfxEmitter_base_life_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_base_life_index], 1000.f, tfxLifePreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_base_amount_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_base_amount_index], 1.f, tfxAmountPreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_base_velocity_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_base_velocity_index], 0.f, tfxVelocityPreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_base_width_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_base_width_index], default_dimensions, tfxDimensionsPreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_base_height_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_base_height_index], default_dimensions, tfxDimensionsPreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_base_weight_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_base_weight_index], 0.f, tfxWeightPreset);
		...
		if (library->graphs[graph_list_index].graphs[tfxEmitter_property_emission_range_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_property_emission_range_index], 0.f, tfxEmissionRangePreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_property_splatter_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_property_splatter_index], 0.f, tfxDimensionsPreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_property_width_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_property_width_index], 1.f, tfxDimensionsPreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_property_height_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_property_height_index], 1.f, tfxDimensionsPreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_property_depth_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_property_depth_index], 1.f, tfxDimensionsPreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_property_extrusion_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_property_extrusion_index], 0.f, tfxDimensionsPreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_property_arc_size_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_property_arc_size_index], tfx_DegreesToRadians(360.f), tfxArcPreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_property_arc_offset_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_property_arc_offset_index], 0.f, tfxArcPreset);

		if (library->graphs[graph_list_index].graphs[tfxEmitter_variation_life_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_variation_life_index], 0.f, tfxLifePreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_variation_amount_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_variation_amount_index], 0.f, tfxAmountPreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_variation_velocity_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_variation_velocity_index], 0.f, tfxVelocityPreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_variation_width_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_variation_width_index], 0.f, tfxDimensionsPreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_variation_height_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_variation_height_index], 0.f, tfxDimensionsPreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_variation_path_trajectory_scale_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_variation_path_trajectory_scale_index], 0.f, tfxGlobalPercentPreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_variation_weight_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_variation_weight_index], 0.f, tfxWeightVariationPreset);
		...
		if (library->graphs[graph_list_index].graphs[tfxEmitter_overtime_roll_spin_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_roll_spin_index], 1.f, tfxSpinOvertimePreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_overtime_pitch_spin_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_pitch_spin_index], 1.f, tfxSpinOvertimePreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_overtime_yaw_spin_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_yaw_spin_index], 1.f, tfxSpinOvertimePreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_overtime_stretch_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_stretch_index], 0.f, tfxPercentOvertime);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_overtime_red_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_red_index], 1.f, tfxColorPreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_overtime_green_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_green_index], 1.f, tfxColorPreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_overtime_blue_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_blue_index], 1.f, tfxColorPreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_overtime_blendfactor_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_blendfactor_index], 0.f, tfxOpacityOvertimePreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_overtime_intensity_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_intensity_index], 1.f, tfxIntensityOvertimePreset);
		...
		if (library->graphs[graph_list_index].graphs[tfxEmitter_overtime_direction_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_direction_index], 0.f, tfxDirectionOvertimePreset);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_overtime_noise_resolution_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_noise_resolution_index], 1.f, tfxPercentOvertime);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_overtime_motion_randomness_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_overtime_motion_randomness_index], 0.f, tfxPercentOvertime);

		if (library->graphs[graph_list_index].graphs[tfxEmitter_factor_life_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_factor_life_index], 1.f, tfxPercentOvertime);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_factor_velocity_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_factor_velocity_index], 1.f, tfxPercentOvertime);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_factor_size_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_factor_size_index], 1.f, tfxPercentOvertime);
		if (library->graphs[graph_list_index].graphs[tfxEmitter_factor_intensity_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxEmitter_factor_intensity_index], 1.f, tfxPercentOvertime);
	}

	if (effect->type == tfxRibbonType) {
		float default_dimensions = 0.2f;
		if (library->graphs[graph_list_index].graphs[tfxRibbon_base_life_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxRibbon_base_life_index], 1000.f, tfxLifePreset);
		if (library->graphs[graph_list_index].graphs[tfxRibbon_base_amount_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxRibbon_base_amount_index], 1.f, tfxAmountPreset);
		if (library->graphs[graph_list_index].graphs[tfxRibbon_base_width_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxRibbon_base_width_index], default_dimensions, tfxDimensionsPreset);

		if (library->graphs[graph_list_index].graphs[tfxRibbon_property_splatter_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxRibbon_property_splatter_index], 0.f, tfxDimensionsPreset);
		if (library->graphs[graph_list_index].graphs[tfxRibbon_property_width_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxRibbon_property_width_index], 1.f, tfxDimensionsPreset);
		if (library->graphs[graph_list_index].graphs[tfxRibbon_property_height_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxRibbon_property_height_index], 1.f, tfxDimensionsPreset);
		if (library->graphs[graph_list_index].graphs[tfxRibbon_property_depth_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxRibbon_property_depth_index], 1.f, tfxDimensionsPreset);
		if (library->graphs[graph_list_index].graphs[tfxRibbon_property_extrusion_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxRibbon_property_extrusion_index], 0.f, tfxDimensionsPreset);
		if (library->graphs[graph_list_index].graphs[tfxRibbon_property_arc_size_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxRibbon_property_arc_size_index], tfx_DegreesToRadians(360.f), tfxArcPreset);
		if (library->graphs[graph_list_index].graphs[tfxRibbon_property_arc_offset_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxRibbon_property_arc_offset_index], 0.f, tfxArcPreset);

		if (library->graphs[graph_list_index].graphs[tfxRibbon_variation_life_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxRibbon_variation_life_index], 0.f, tfxLifePreset);
		if (library->graphs[graph_list_index].graphs[tfxRibbon_variation_amount_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxRibbon_variation_amount_index], 0.f, tfxAmountPreset);
		...
		if (library->graphs[graph_list_index].graphs[tfxRibbon_overtime_blendfactor_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxRibbon_overtime_blendfactor_index], 0.f, tfxOpacityOvertimePreset);
		if (library->graphs[graph_list_index].graphs[tfxRibbon_overtime_intensity_index].nodes.size() == 0) tfx__reset_graph(&library->graphs[graph_list_index].graphs[tfxRibbon_overtime_intensity_index], 1.f, tfxIntensityOvertimePreset);
...
void tfx__add_emitter_color_overtime(tfx_effect_descriptor emitter, float frame, tfx_rgb_t color) {
	if (emitter->type == tfxEmitterType) {
		tfx__add_graph_node_values(&emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxEmitter_overtime_red_index], frame, color.r);
		tfx__add_graph_node_values(&emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxEmitter_overtime_green_index], frame, color.g);
		tfx__add_graph_node_values(&emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxEmitter_overtime_blue_index], frame, color.b);
	} else {
		tfx__add_graph_node_values(&emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxRibbon_overtime_red_index], frame, color.r);
		tfx__add_graph_node_values(&emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxRibbon_overtime_green_index], frame, color.g);
		tfx__add_graph_node_values(&emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxRibbon_overtime_blue_index], frame, color.b);
	}
}
...
tfx_particle_emitter_properties_t *tfx__get_particle_emitter_properties(tfx_effect_descriptor effect) {
	return effect->state_properties.property_index != tfxINVALID ? &effect->library->emitter_properties[effect->state_properties.property_index] : nullptr;
}

tfx_shared_properties_t *tfx__get_shared_emitter_properties(tfx_effect_descriptor effect) {
	return effect->state_properties.shared_index != tfxINVALID ? &effect->library->shared_properties[effect->state_properties.shared_index] : nullptr;
}

tfx_ribbon_emitter_properties_t *tfx__get_ribbon_emitter_properties(tfx_effect_descriptor effect) {
	tfx_ribbon_emitter_properties_t *properties = &effect->library->ribbon_properties[effect->state_properties.property_index];
	return properties;
}

bool tfx__rename_child(tfx_effect_descriptor emitter, const char *new_name) {
...
void tfx__reindex_effect(tfx_effect_descriptor effect) {
	tfxU32 index = 0;
	for (tfx_effect_descriptor child : effect->children) {
		child->library_index = index++;
		child->parent = effect;
		tfx__reindex_effect(child);
	}
}
...
void tfx__clear_effect(tfx_effect_descriptor effect) {
	...
	while (stack.size()) {
		...
		if (current->state_properties.graph_list_index != tfxINVALID) {
			tfx__free_library_graph_list(effect->library, current->state_properties.graph_list_index);
		}
		if (current->state_properties.transform_index != tfxINVALID) {
			tfx__free_library_graph_list(effect->library, current->state_properties.transform_index);
		}
...
void tfx__clone_effect(tfx_effect_descriptor effect_to_clone, tfx_effect_descriptor clone, tfx_library destination_library, tfxEffectCloningFlags flags) {
	*clone = *effect_to_clone;
	clone->children.init();
	if (effect_to_clone->state_properties.shared_index != tfxINVALID) {
		clone->state_properties.shared_index = tfx__clone_library_shared_properties(clone->library, effect_to_clone->state_properties.shared_index, destination_library);
	}
	switch (clone->type) {
	case tfxEmitterType:
	...
	clone->state_properties.shared_flags |= tfxSharedEmitterPropertyFlags_enabled;
	...
	if (effect_to_clone->type == tfxEffectType) {
		...
		if (flags & tfxEffectCloningFlags_clone_camera_settings && effect_to_clone->preview_camera_settings != tfxINVALID) {
		...
		if (clone->state_properties.path_attributes != tfxINVALID) {
			...
			tfx_emitter_path_t &src_path = library->paths[clone->state_properties.path_attributes];
...
void tfx__add_template_path(tfx_effect_template effect_template, tfx_effect_descriptor effect_emitter, const char *path) {
	...
	for (tfx_effect_descriptor sub : effect_emitter->children) {
...
void tfx__enable_all_emitters(tfx_effect_descriptor effect) {
	for (tfx_effect_descriptor child : effect->children) {
		child->state_properties.shared_flags |= tfxSharedEmitterPropertyFlags_enabled;
		tfx__enable_all_emitters(child);
	}
}
void tfx__render_all_emitters(tfx_effect_descriptor effect) {
	for (tfx_effect_descriptor child : effect->children) {
		child->state_properties.shared_flags &= ~tfxSharedEmitterPropertyFlags_do_not_render;
	}
}
...
void tfx__disable_all_emitters(tfx_effect_descriptor effect) {
	for (tfx_effect_descriptor child : effect->children) {
		child->state_properties.shared_flags &= ~tfxSharedEmitterPropertyFlags_enabled;
		tfx__disable_all_emitters(child);
	}
}
...
void tfx__disable_all_emitters_except(tfx_effect_descriptor effect, tfx_effect_descriptor emitter) {
	...
	if (effect->library->effect_paths.ValidKey(enable_source_emitter)) {
		effect->library->effect_paths.At(enable_source_emitter)->state_properties.shared_flags |= tfxSharedEmitterPropertyFlags_enabled;
	}
}

void tfx__hide_descriptor(tfx_effect_descriptor descriptor) {
	descriptor->state_properties.shared_flags |= tfxSharedEmitterPropertyFlags_hidden;
...
tfx_graph_t *tfx__get_effect_graph_by_index(tfx_effect_descriptor effect, tfxU32 index) {
	tfx_library library = effect->library;
	TFX_ASSERT(index < effect->library->graphs[effect->state_properties.graph_list_index].graphs.current_size);	//index is out of bounds. Maybe the effect descriptor is not the type you think it is?
	return &effect->library->graphs[effect->state_properties.graph_list_index].graphs[index];
}

tfx_graph_t *tfx__get_effect_transform_graph_by_index(tfx_effect_descriptor effect, tfxU32 index) {
	tfx_library library = effect->library;
	TFX_ASSERT(index < effect->library->graphs[effect->state_properties.transform_index].graphs.current_size);	//index is out of bounds. Are you sure this is an index for a transform graph
	return &effect->library->graphs[effect->state_properties.transform_index].graphs[index];
}
...
tfxU32 tfx__get_effect_graph_index_by_type(tfx_effect_descriptor effect, tfx_graph_type type) {
	if ((int)type < (int)tfxTransform_start) {
		return effect->state_properties.graph_list_index;
	}
	else {
		return effect->state_properties.transform_index;
	}
}
...
tfxU32 tfx__create_emitter_path_attributes(tfx_effect_descriptor emitter, bool add_node) {
	...
	return emitter->state_properties.path_attributes;
}
...
tfx_emitter_path_t *tfx__get_path(tfx_effect_descriptor descriptor) {
	if (descriptor->state_properties.path_attributes == tfxINVALID) return nullptr;
	TFX_ASSERT_HANDLE(descriptor->library);	//Not a valid library handle in effect descriptor, is it a valid effect or emitter?
	return &descriptor->library->paths[descriptor->state_properties.path_attributes];
}
...
void tfx__build_path_nodes(tfx_emitter_path_t *path) {
	...
	if (path->buffers.node_buffer.current_size < node_count) {
		if (node_count >= path->buffers.node_buffer.capacity) {
			tfx__grow_soa_arrays(&path->buffers.node_buffer, path->buffers.node_buffer.capacity, node_count);
		}
		path->buffers.node_buffer.current_size = node_count;
	}
	tfx_vector_t<tfx_vec4_t> path_nodes;
	path_nodes.resize(node_count);
...
void tfx__free_graph_list_graphs(tfx_graph_list_t *graph_list) {
...
void tfx__add_library_path(tfx_library library, tfx_effect_descriptor effect_descriptor, const char *path, bool skip_existing) {
	TFX_ASSERT_HANDLE(library);	//Not a valid library handle
	TFX_ASSERT_HANDLE(effect_descriptor);	//Not a valid effect handle
	if (library->effect_paths.ValidName(path) && !skip_existing) {
		tfx_str256_t new_path = tfx__find_new_path_name(library, path);
		effect_descriptor->path.Set(new_path.c_str());
		effect_descriptor->name = tfx__get_name_from_path(path);
...
tfx_effect_descriptor tfx__add_new_library_effect(tfx_library library, tfx_str64_t *name) {
	TFX_ASSERT_HANDLE(library);	//Not a valid library handle
	tfx_effect_descriptor effect = tfx_NewEffectDescriptor(tfxEffectType);
	effect->library = library;
	effect->type = tfxEffectType;
	effect->state_properties.property_index = tfx__allocate_library_particle_emitter_properties(library);
	effect->state_properties.shared_index = tfx__allocate_library_shared_properties(library);
	tfx__add_library_effect_graphs(library, effect);
	tfx__reset_effect_graphs(effect, true);
	effect->state_properties.transform_index = tfx__add_library_transform_graphs(library);
...
void tfx__reindex_library(tfx_library library) {
	...
	tfxU32 index = 0;
	for (tfx_effect_descriptor library_effect : library->effects) {
		library_effect->library_index = index++;
		library_effect->parent = nullptr;
		tfx__reindex_effect(library_effect);
	}
}
	...
	while (stack.size()) {
		...
		if (current->type == tfxEmitterType || current->type == tfxRibbonType) {
			...
			if (!shape_found) {
				...
				current->state_properties.end_frame = image->animation_frames - 1;
			}
		}
		for (tfx_effect_descriptor sub : current->children) {
			stack.push_back(sub);
...
void tfx_BuildLibraryGPUShapeData(tfx_library library, tfx_gpu_shapes shapes, void(uv_lookup)(void *ptr, tfx_gpu_image_data_t *image_data, int offset)) {
	TFX_ASSERT_HANDLE(library);	//Not a valid library handle
	TFX_ASSERT_HANDLE(shapes);	//shapes handle is not initialised. Use tfx_CreateGPUShapes() to create a new tfx_gpu_shapes object
...
void tfx_BuildAnimationManagerGPUShapeData(tfx_animation_manager animation_manager, tfx_gpu_shapes shapes, void(uv_lookup)(void *ptr, tfx_gpu_image_data_t *image_data, int offset)) {
	TFX_ASSERT_HANDLE(shapes);				//shapes handle is not initialised. Use tfx_CreateGPUShapes() to create a new tfx_gpu_shapes object
	TFX_ASSERT_HANDLE(animation_manager);	//animation_manager handle not initialised! Use tfx_CreateAnimationManagerFor2d/3d and load or record sprite data into it.
...
bool tfx__is_library_shape_used(tfx_library library, tfxKey image_hash) {
	...
	while (effect_stack.size()) {
		...
		if (current->type == tfxEmitterType) {
			if (current->state_properties.image->image_hash == image_hash) {
				effect_stack.free();
				return true;
			}
		}
...
tfxU32 tfx__add_library_graphs(tfx_library library, tfx_effect_descriptor_type type) {
	...
	graph_list.effect_descriptor_type = type;
	switch (type) {
	case tfxEffectType:
		tfx__initialise_effect_graphs(&graph_list);
		break;
	case tfxEmitterType:
		tfx__initialise_emitter_graphs(&graph_list);
		break;
	case tfxRibbonType:
...
void tfx__add_library_effect_graphs(tfx_library library, tfx_effect_descriptor effect) {
	...
	if (root_effect == effect) {
		effect->state_properties.graph_list_index = tfx__add_library_graphs(library, tfxEffectType);
	} else {
		effect->state_properties.graph_list_index = root_effect->state_properties.graph_list_index;
	}
}
...
tfxU32 tfx__add_library_preview_camera_settings_effect(tfx_library library, tfx_effect_descriptor effect) {
	...
	effect->preview_camera_settings = library->preview_camera_settings.size() - 1;
...
tfx_str64_t tfx__get_name_from_path(const char *path) {
	...
	tfx__split_string_stack(path, (int)strlen(path), &file_split, '/');
	if (file_split.size()) {
...
void tfx__update_library_compute_nodes() {
	...
	for (tfx_library library : tfxStore->libraries.data) {
		for (tfx_effect_descriptor effect : library->effects) {
			if (effect->state_properties.property_flags & tfxEffectPropertyFlags_history_effect) {
				continue;
			}
			stack.push_back(effect);
			while (!stack.empty()) {
...
void tfx__update_library_emitter_compute_nodes(tfx_effect_descriptor_t *emitter) {
	...
	for (tfx_graph_t &graph : emitter->library->graphs[emitter->state_properties.graph_list_index].graphs) {
...
void tfx__initialise_graph_indexes() {
	...
	tfxStore->graph_indexes.Insert("variation_path_trajectory_scale", tfxEmitter_variation_path_trajectory_scale_index);
...
void tfx__initialise_dictionary(tfx_data_types_dictionary_t *dictionary) {
	...
	names_and_types.Insert("variation_path_trajectory_scale", tfxAttributeGraph);
...
void tfx__assign_graph_properties(tfx_effect_descriptor effect, tfx_vector_t<tfx_str256_t> *values) {
	...
	if (effect->state_properties.graph_list_index == tfxINVALID && data_type == tfxAttributeGraph) {
		return;
	}

	switch (data_type) {
	case tfxAttributeGraph: graph = &effect->library->graphs[effect->state_properties.graph_list_index].graphs[graph_index]; break;
...
void tfx__assign_animation_emitter_property_vec2(tfx_animation_emitter_properties_t *properties, tfx_str256_t *field, tfx_vec2_t value, tfxU32 file_version) {
	if (*field == "handle") {
		properties->handle = value;
	}
}

void tfx__assign_animation_emitter_property_float(tfx_animation_emitter_properties_t *properties, tfx_str256_t *field, float value, tfxU32 file_version) {
	if (*field == "animation_frames")
		properties->animation_frames = value;
}

void tfx__assign_animation_emitter_property_u32(tfx_animation_emitter_properties_t *properties, tfx_str256_t *field, tfxU32 value, tfxU32 file_version) {
...
tfx_str64_t tfx__graph_type_to_property_string(tfx_graph_type graph_type) {
	...
	case tfxVariation_path_trajectory_scale: return "variation_path_trajectory_scale"; break;
...
void tfx__assign_sprite_data_metrics_property_str(tfx_sprite_data_metrics_t *metrics, tfx_str256_t *field, const char *value, tfxU32 file_version) {
	TFX_ASSERT(strlen(value) <= 64);	//Trying to assign property that is too large
...
void tfx__assign_effector_property_u32(tfx_effect_descriptor effect, tfx_str256_t *field, tfxU32 value, tfxU32 file_version) {
	...
	else if (*field == "sprite_data_seed") effect->library->sprite_data_settings[effect->sprite_data_settings_index].seed = value;
	else if (*field == "sprite_data_frame_offset") effect->library->sprite_data_settings[effect->sprite_data_settings_index].frame_offset = value;
...
void tfx__assign_effector_property(tfx_effect_descriptor effect, tfx_str256_t *field, float value) {
	...
	else if (*field == "scale") effect->library->sprite_sheet_settings[effect->sprite_sheet_settings_index].scale = value;
	else if (*field == "playback_speed") effect->library->sprite_sheet_settings[effect->sprite_sheet_settings_index].playback_speed = value;
	else if (*field == "camera_position_x") effect->library->sprite_sheet_settings[effect->sprite_sheet_settings_index].camera_settings.camera_position.x = value;
	else if (*field == "camera_position_y") effect->library->sprite_sheet_settings[effect->sprite_sheet_settings_index].camera_settings.camera_position.y = value;
	else if (*field == "camera_position_z") effect->library->sprite_sheet_settings[effect->sprite_sheet_settings_index].camera_settings.camera_position.z = value;
	else if (*field == "camera_pitch") effect->library->sprite_sheet_settings[effect->sprite_sheet_settings_index].camera_settings.camera_pitch = value;
	else if (*field == "camera_yaw") effect->library->sprite_sheet_settings[effect->sprite_sheet_settings_index].camera_settings.camera_yaw = value;
	...
	else if (*field == "preview_camera_pitch") effect->library->preview_camera_settings[effect->preview_camera_settings].camera_settings.camera_pitch = value;
	else if (*field == "preview_camera_yaw") effect->library->preview_camera_settings[effect->preview_camera_settings].camera_settings.camera_yaw = value;
	else if (*field == "preview_camera_fov") effect->library->preview_camera_settings[effect->preview_camera_settings].camera_settings.camera_fov = value;
	else if (*field == "preview_camera_floor_height") effect->library->preview_camera_settings[effect->preview_camera_settings].camera_settings.camera_floor_height = value;
...
void tfx__assign_effector_property_bool(tfx_effect_descriptor effect, tfx_str256_t *field, bool value) {
	if (*field == "loop") effect->library->sprite_sheet_settings[effect->sprite_sheet_settings_index].animation_flags |= value ? tfxAnimationFlags_loop : 0;
	else if (*field == "seamless") effect->library->sprite_sheet_settings[effect->sprite_sheet_settings_index].animation_flags |= value ? tfxAnimationFlags_seamless : 0;
		...
		if (value) { effect->state_properties.shared_flags |= tfxSharedEmitterPropertyFlags_hidden; } else { effect->state_properties.shared_flags &= ~tfxSharedEmitterPropertyFlags_hidden; }
	} else if (*field == "random_color") {
		if (value) { effect->state_properties.shared_flags |= tfxSharedEmitterPropertyFlags_random_color; } else { effect->state_properties.shared_flags &= ~tfxSharedEmitterPropertyFlags_random_color; }
	} else if (*field == "exclude_from_global_hue") {
		if (value) { effect->state_properties.shared_flags |= tfxSharedEmitterPropertyFlags_exclude_from_hue_adjustments; } else { effect->state_properties.shared_flags &= ~tfxSharedEmitterPropertyFlags_exclude_from_hue_adjustments; }
	} else if (*field == "relative_position") {
		if (value) { effect->state_properties.shared_flags |= tfxSharedEmitterPropertyFlags_relative_position; } else { effect->state_properties.shared_flags &= ~tfxSharedEmitterPropertyFlags_relative_position; }
	} else if (*field == "run_on_gpu") {
		if (value) { effect->state_properties.property_flags |= tfxEmitterPropertyFlags_run_on_gpu; } else { effect->state_properties.property_flags &= ~tfxEmitterPropertyFlags_run_on_gpu; }
		...
		if (value) { effect->state_properties.property_flags |= tfxEmitterPropertyFlags_wrap_single_sprite; } else { effect->state_properties.property_flags &= ~tfxEmitterPropertyFlags_wrap_single_sprite; }
	} else if (*field == "spawn_on_grid") {
		if (value) { effect->state_properties.shared_flags |= tfxSharedEmitterPropertyFlags_spawn_on_grid; } else { effect->state_properties.shared_flags &= ~tfxSharedEmitterPropertyFlags_spawn_on_grid; }
	} else if (*field == "grid_spawn_clockwise") {
		if (value) { effect->state_properties.shared_flags |= tfxSharedEmitterPropertyFlags_grid_spawn_clockwise; } else { effect->state_properties.shared_flags &= ~tfxSharedEmitterPropertyFlags_grid_spawn_clockwise; }
		...
		if (value) { effect->state_properties.shared_flags |= tfxSharedEmitterPropertyFlags_emitter_handle_auto_center; } else { effect->state_properties.shared_flags &= ~tfxSharedEmitterPropertyFlags_emitter_handle_auto_center; }
	} else if (*field == "edge_traversal") {
		if (value) { effect->state_properties.property_flags |= tfxEmitterPropertyFlags_edge_traversal; } else { effect->state_properties.property_flags &= ~tfxEmitterPropertyFlags_edge_traversal; }
	} else if (*field == "image_reverse_animation") {
		if (value) { effect->state_properties.shared_flags |= tfxSharedEmitterPropertyFlags_reverse_animation; } else { effect->state_properties.shared_flags &= ~tfxSharedEmitterPropertyFlags_reverse_animation; }
	} else if (*field == "image_play_once") {
		if (value) { effect->state_properties.shared_flags |= tfxSharedEmitterPropertyFlags_play_once; } else { effect->state_properties.shared_flags &= ~tfxSharedEmitterPropertyFlags_play_once; }
	} else if (*field == "image_animate") {
		if (value) { effect->state_properties.shared_flags |= tfxSharedEmitterPropertyFlags_animate; } else { effect->state_properties.shared_flags &= ~tfxSharedEmitterPropertyFlags_animate; }
		...
		if (value) { effect->state_properties.property_flags |= tfxEmitterPropertyFlags_lifetime_uniform_size; } else { effect->state_properties.property_flags &= ~tfxEmitterPropertyFlags_lifetime_uniform_size; }
	} else if (*field == "use_spawn_ratio") {
		if (value) { effect->state_properties.property_flags |= tfxEmitterPropertyFlags_use_spawn_ratio; } else { effect->state_properties.property_flags &= ~tfxEmitterPropertyFlags_use_spawn_ratio; }
		...
		if (value) { effect->state_properties.property_flags |= tfxEmitterPropertyFlags_alt_color_lifetime_sampling; } else { effect->state_properties.property_flags &= ~tfxEmitterPropertyFlags_alt_color_lifetime_sampling; }
...
void tfx__stream_particle_emitter_properties(tfx_effect_descriptor emitter, tfx_shared_properties_t *shared_properties, tfx_particle_emitter_properties_t *properties, tfxSharedEmitterFlags shared_flags, tfxParticleEmitterFlags flags, tfx_stream_t *file) {
	...
	file->AddLine("image_end_frame=%f", emitter->state_properties.end_frame);
	...
	file->AddLine("emission_direction=%i", properties->emission_direction);
	file->AddLine("noise_algorithm=%i", properties->noise_algorithm);
	...
	file->AddLine("angle_offset=%f", emitter->state_properties.angle_offsets.roll);
	file->AddLine("angle_offset_pitch=%f", emitter->state_properties.angle_offsets.pitch);
	file->AddLine("angle_offset_yaw=%f", emitter->state_properties.angle_offsets.yaw);
...
bool tfx__set_node(tfx_graph_t *graph, tfx_attribute_node_t *node, float *frame, float *value) {
	...
	*value = node->value;
	...
	if (!(node->flags & tfxAttributeNodeFlags_curves_initialised) && graph->flags & tfxGraphFlags_multi_node_graph) {
		tfx__unset_curves(graph, node->index);
	}
...
void tfx__clamp_graph_nodes(tfx_graph_t *graph) {
	for (tfxBucketLoop(graph->nodes, i)) {
		...
		if (graph->nodes[i].flags & tfxAttributeNodeFlags_is_curve) {
			...
			tfx__set_left_node_curve(graph, &graph->nodes[i].left, &graph->nodes[i]);
			tfx__set_left_node_curve(graph, &graph->nodes[i].right, &graph->nodes[i]);
		} else {
...
void tfx__set_node_curve_frames(tfx_graph_t *graph) {
	for(tfxBucketLoop(graph->nodes, i)) {
		tfx__set_left_node_curve(graph, &graph->nodes[i].left, &graph->nodes[i]);
		tfx__set_right_node_curve(graph, &graph->nodes[i].right, &graph->nodes[i]);
	}
}
...
void tfx__update_graph_wide_oscillator(tfx_graph_t *graph) {
	graph->wide_oscillator.frequency = tfxWideSetSingle(graph->oscillator.frequency);
	graph->wide_oscillator.amplitude = tfxWideSetSingle(graph->oscillator.amplitude);
	graph->wide_oscillator.offset_x = tfxWideSetSingle(graph->oscillator.offset_x);
	graph->wide_oscillator.offset_y = tfxWideSetSingle(graph->oscillator.offset_y);
}
...
void tfx__copy_graph_color(tfx_graph_list_t *from, tfx_graph_list_t *to, tfx_effect_descriptor_type from_type, tfx_effect_descriptor_type to_type) {
	...
	for (tfxBucketLoop(from->graphs[from_red_index].nodes, i)) {
		to->graphs[to_red_index].nodes.push_back(from->graphs[from_red_index].nodes[i]);
	}
	for (tfxBucketLoop(from->graphs[from_green_index].nodes, i)) {
		to->graphs[to_green_index].nodes.push_back(from->graphs[from_green_index].nodes[i]);
	}
	for (tfxBucketLoop(from->graphs[from_blue_index].nodes, i)) {
		to->graphs[to_blue_index].nodes.push_back(from->graphs[from_blue_index].nodes[i]);
	}
}
...
void tfx__copy_graph_colors(tfx_graph_t *from_red, tfx_graph_t *from_green, tfx_graph_t *from_blue, tfx_graph_t *to_red, tfx_graph_t *to_green, tfx_graph_t *to_blue) {
	...
	for (tfxBucketLoop(from_red->nodes, i)) {
		to_red->nodes.push_back(from_red->nodes[i]);
	}
	for (tfxBucketLoop(from_green->nodes, i)) {
		to_green->nodes.push_back(from_green->nodes[i]);
	}
	for (tfxBucketLoop(from_blue->nodes, i)) {
...
void tfx__flip_graph(tfx_graph_t *graph) {
	if (graph->nodes.size() == 1) {
		return;
	}
	int left = 0;
...
void tfx__update_lerp_graph(tfx_graph_t *graph) {
	if (tfx__is_lerp_graph(graph)) {
		if (graph->nodes.size() == 1) {
			...
			graph->nodes[1] = graph->nodes.back();
			graph->nodes.trim_buckets();
		}
...
void tfx__maybe_insert_color_ramp_bitmap(tfx_library library, tfx_graph_list_t *graph_list) {
	tfxKey hash = tfx_Hash(&tfxStore->hasher, &graph_list->color_ramps, sizeof(tfx_rgba8_t) * tfxCOLOR_RAMP_WIDTH, 0);
...
float tfx__sample_multi_node_graph(tfx_graph_t *graph, float age, float osc_t) {
	if (graph->nodes.empty()) return 0.f;
	...
	for (tfxU32 i = 1; i < graph->nodes.current_size; i++) {
		...
		if (age < curr->frame) {
			...
			if (osc_t && tfx__graph_can_oscillate(graph)) {
				float value = ti2 * ti * prev->value + 3.f * t_ti2 * prev->right.y + 3.f * t2_ti * curr->left.y + t2 * t * curr->value;
				return value * (tfxOSCILLATOR_SIN(osc_t + graph->oscillator.offset_x, graph->oscillator.frequency, graph->oscillator.amplitude) + graph->oscillator.offset_y);
			}
			return ti2 * ti * prev->value + 3.f * t_ti2 * prev->right.y + 3.f * t2_ti * curr->left.y + t2 * t * curr->value;
		}
		prev = curr;
...
float tfx__get_max_life(tfx_effect_descriptor emitter) {
	tfx_graph_t &life = emitter->type == tfxEmitterType ? emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxEmitter_base_life_index] : emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxRibbon_base_life_index];
	tfx_graph_t &life_variation = emitter->type == tfxEmitterType ? emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxEmitter_variation_life_index] : emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxRibbon_variation_life_index];
	float templife = 0;
	float max_life = 0;
	...
	if (life_last_frame + life_variation_last_frame > 0) {
		for (float f = 0; f < fmaxf(life_last_frame, life_variation_last_frame); ++f) {
			if (emitter->parent) {
				global_adjust = tfx__get_graph_value_by_age(&emitter->parent->library->graphs[emitter->parent->state_properties.graph_list_index].graphs[tfxEffect_global_life_index], f);
			}
...
void tfx__add_data_value_str(tfx_storage_map_t<tfx_data_entry_t> *config, const char *key, const char *value) {
	tfx_data_entry_t entry;
	entry.type = tfxString;
	entry.key.Set(key);
	entry.str_value.Set(value);
	entry.str_value.SanitizeLineFeeds();
	config->Insert(key, entry);
}

void tfx__add_data_value_int(tfx_storage_map_t<tfx_data_entry_t> *config, const char *key, int value) {
	tfx_data_entry_t entry;
	entry.type = tfxSInt;
	entry.key.Set(key);
...
void tfx__add_color_value(tfx_storage_map_t<tfx_data_entry_t> *config, const char *key, tfx_rgba8_t color) {
	tfx_data_entry_t entry;
	entry.type = tfxColor;
	entry.key.Set(key);
...
void tfx__add_color_value_from_int(tfx_storage_map_t<tfx_data_entry_t> *config, const char *key, tfxU32 color) {
	tfx_data_entry_t entry;
	entry.type = tfxColor;
	entry.key.Set(key);
...
void tfx__add_data_value_bool(tfx_storage_map_t<tfx_data_entry_t> *config, const char *key, bool value) {
	tfx_data_entry_t entry;
	entry.type = tfxBool;
	entry.key.Set(key);
...
bool tfx__save_data_file(tfx_storage_map_t<tfx_data_entry_t> *config, const char *path) {
	...
	if (config->Size()) {
		for (auto &entry : config->data) {
			tfx_str512_t ini_line;
			ini_line.Set(entry.key.c_str());
			ini_line.Appendf("=");
			switch (entry.type) {
			case tfxString:
...
bool tfx__load_data_file(tfx_data_types_dictionary_t *data_types, tfx_storage_map_t<tfx_data_entry_t> *config, const char *path) {
	...
	while (fgets(buffer, max_line_length, fp)) {
		...
		tfx_line_t line = tfx__read_line(buffer);
		pair.clear();
		...
		if (pair.size() == 2) {
			if (names_and_types.ValidName(pair[0].c_str()) && pair[0].Length()) {
				...
				if (t == tfxSInt) {
					tfx__add_data_value_int(config, pair[0].c_str(), atoi(pair[1].c_str()));
				}
				else if (t == tfxFloat) {
					tfx__add_data_value_float(config, pair[0].c_str(), (float)atof(pair[1].c_str()));
				}
				else if (t == tfxString) {
					tfx__add_data_value_str(config, pair[0].c_str(), pair[1].c_str());
				}
				else if (t == tfxColor) {
					char *endptr;
					tfx__add_color_value_from_int(config, pair[0].c_str(), (tfxU32)strtoul(pair[1].c_str(), &endptr, 10));
				}
			}
		}
	}
...
tfx_line_t tfx__read_line(const char *s) {
	tfx_line_t line{};
	if (!s) return line;
...
void tfx__split_string_stack(const char *str, int length, tfx_vector_t<tfx_str256_t> *pair, char delim) {
	tfx_str256_t item;
	for (int i = 0; i != length; ++i) {
		if (str[i] == delim && item.Length() && str[i] != 0) {
			pair->push_back(item);
			item.Clear();
		}
		else if (str[i] != 0) {
...
void tfx__split_string_vec(const char *str, int length, tfx_vector_t<tfx_str256_t> *pair, char delim) {
	tfx_str256_t item;
	for (int i = 0; i != length; ++i) {
		if (str[i] == delim && item.Length() && str[i] != 0) {
			pair->push_back(item);
...
bool tfx__line_is_uint(tfx_line_t *line) {
	...
	for (size_t i = 0; i != line->length; i++) {
		if (!isdigit((unsigned char)line->start[i])) {
			return false;
		}
	}
	return true;
...
tfxAPI tfxErrorFlags tfx_LoadSpriteData(const char *filename, tfx_animation_manager animation_manager, void(*shape_loader)(const char *filename, tfx_image_data_t *image_data, void *raw_image_data, int image_size, void *user_data), void *user_data) {
			...
			if (context == tfxStartEffectAnimationInfo) {
				if (names_and_types.ValidName(pair[0].c_str())) {
					...
					case tfxFloat:
						...
						break;
					case tfxString:
						tfx__assign_sprite_data_metrics_property_str(&metrics_stack.back(), &pair[0], pair[1].c_str(), package->header.file_version);
						break;
					default:
						break;
					}
				...
				if (names_and_types.ValidName(pair[0].c_str())) {
					...
					case tfxFloat3:
						multi.clear();
						tfx__split_string_stack(pair[1].c_str(), pair[1].Length(), & multi, ',');
	...
	tfx_str256_t bitmap_file_name;
	bitmap_file_name.Set("color_ramp_0");
...
tfxErrorFlags tfx__load_effect_library_package(tfx_package package, tfx_library lib, void(*shape_loader)(const char *filename, tfx_image_data_t *image_data, void *raw_image_data, int image_size, void *user_data), void(uv_lookup)(void *ptr, tfx_gpu_image_data_t *image_data, int offset), void *user_data) {
	...
	int context = 0;
	int uid = 0;
	tfxU32 current_effect_graph_index = 0;
	...
	while (!data->data.EoF()) {
		...
		if (tfx__line_is_uint(&line)) {
			...
			if (context == tfxStartFolder) {
				...
				if (effect_stack.size() <= 1) { //Only root effects get the global graphs
					...
					current_effect_graph_index = effect->state_properties.graph_list_index;
				}
				effect->state_properties.transform_index = tfx__add_library_transform_graphs(lib);
				...
				tfx__reset_emitter_graphs(emitter, false);
				...
				ribbon->state_properties.graph_list_index = tfx__add_library_graphs(lib, tfxRibbonType);
				ribbon->state_properties.transform_index = tfx__add_library_transform_graphs(lib);
				ribbon->type = tfx_effect_descriptor_type::tfxRibbonType;
				tfx__reset_ribbon_graphs(ribbon, false);
		...
		if (context_set == false) {
			if (context == tfxStartEffect && !current_effect) {
				continue;
			}
			pair.clear();
			tfx__split_string_stack(line.start, line.length, &pair);
		...
		if (context == tfxEndEmitter) {
			...
			if (effect_stack.back()->state_properties.property_flags & tfxEmitterPropertyFlags_image_handle_auto_center) {
				lib->emitter_properties[effect_stack.back()->state_properties.property_index].image_handle = { .5f, .5f };
			}
			tfx_vec2_t handle = lib->emitter_properties[effect_stack.back()->state_properties.property_index].image_handle;
			effect_stack.back()->state_properties.image_handle_packed = (tfxU64)tfx__pack16bit_sscaled(handle.x, handle.y, 128.f) << 32;
			effect_stack.back()->state_properties.shared_flags |= tfxSharedEmitterPropertyFlags_enabled;
			TFX_ASSERT(current_effect);
			TFX_ASSERT_HANDLE(effect_stack.back());
			current_effect->children.push_back(effect_stack.back());
			effect_stack.pop();
		}
...
void tfx__reset_ribbon_data_lerp_offset(tfx_sprite_data_t *sprite_data) {
	tfx_ribbon_data_soa_t &ribbons = sprite_data->real_time_ribbons;
	for (int i = 0; i != sprite_data->real_time_ribbons_buffer.current_size; ++i) {
		ribbons.lerp_offset[i] = 1.f;
	}
}
...
void tfx__record_sprite_data(tfx_effect_manager pm, tfx_effect_descriptor effect, tfx_sprite_data_settings_t *settings, tfx_sprite_data_t *sprite_data, float update_frequency, float camera_position[3], int *progress) {
	...
	*progress = tfxCalculateFrames;
	...
	tfxU32 struct_size = sizeof(tfx_instance_t);
	for (tfxEachLayer) {
	...
	while (frame < frames && offset < 99999) {
		...
		if (offset >= start_frame) {
			...
			if (frame >= tmp_ribbon_frame_meta.size()) {
				tmp_ribbon_frame_meta.push_back({});
			}
	...
	*progress = tfxBakeSpriteData;
	...
	if (!sprite_data) {
		if (effect->library->pre_recorded_effects.ValidKey(effect->path_hash)) {
			...
			if (total_ribbons > 0) {
				sprite_data->normal.ribbon_frame_meta.resize(frames);
				sprite_data->normal.ribbon_frame_meta.zero();
			}
		} else {
			effect->library->pre_recorded_effects.Insert(effect->path_hash, {});
			sprite_data = &effect->library->pre_recorded_effects.At(effect->path_hash);
			tfx__init_soa_buffer(&sprite_data->real_time_sprites_buffer);
			...
			sprite_data->normal.frame_meta.zero();
			if (total_ribbons > 0) {
				tfx__init_soa_buffer(&sprite_data->real_time_ribbons_buffer);
	...
	frame_meta.copy(tmp_frame_meta);
	tmp_frame_meta.free();
	...
	tfx_vector_t<tfx_ribbon_frame_meta_t> &ribbon_frame_meta = sprite_data->normal.ribbon_frame_meta;
	if (total_ribbons > 0) {
		ribbon_frame_meta.copy(tmp_ribbon_frame_meta);
		last_count = 0;
		for (tfx_ribbon_frame_meta_t &meta : ribbon_frame_meta) {
			meta.captured_offset = last_count;
			meta.index_offset = last_count;
			last_count += meta.ribbon_count;
		}
	}
...
TFX_ENABLE_COMPILER_WARNING()
	...
	tfx__init_sprite_data_soa(&sprite_data->real_time_sprites_buffer, &sprite_data->real_time_sprites, total_sprites);
	for (tfxEachLayer) {
	...
	if (total_ribbons > 0) {
		sprite_data->normal.total_ribbons = total_ribbons;
		sprite_data->normal.total_memory_for_ribbons = total_ribbons * (tfxU32)sprite_data->real_time_ribbons_buffer.struct_size;
		tfx__init_soa_buffer(&temp_ribbons_buffer);
		tfx__init_ribbon_data_soa(&temp_ribbons_buffer, &temp_ribbons, 100);
		tfx__init_ribbon_data_soa(&sprite_data->real_time_ribbons_buffer, &sprite_data->real_time_ribbons, total_ribbons);
	}
	...
	while (frame < frames && offset < 99999) {
		...
		if (offset >= start_frame) {
			if (offset == start_frame && start_frame > 0) {
				for (tfxEachLayer) {
					tfx__invalidate_offsetted_sprite_captured_index(tfxCastBufferRef(tfx_instance_t, pm->instance_buffer_for_recording[pm->current_sprite_buffer][layer]), pm->unique_sprite_ids[pm->current_sprite_buffer][layer], pm, layer);
				}
			}
			for (tfxEachLayer) {
				if (running_count[layer][frame] > 0 && pm->layer_sizes[layer] > 0) {
					...
					tfx__resize_soa_buffer(&temp_sprites_buffer[layer], running_count[layer][frame]);
					...
					memcpy(temp_sprites[layer].billboard_instance, sprite_data->real_time_sprites.billboard_instance + frame_meta[frame].index_offset[layer], sizeof(tfx_instance_t) * running_count[layer][frame]);
			...
			for(tfxEachLayer) {
				tfx_instance_t *billboards = tfxCastBufferRef(tfx_instance_t, pm->instance_buffer_for_recording[pm->current_sprite_buffer][layer]);
				...
				memcpy(sprite_data->real_time_sprites.billboard_instance + frame_meta[frame].index_offset[layer], billboards, sizeof(tfx_instance_t) * pm->layer_sizes[layer]);
				...
				if (running_count[layer][frame] > 0 && pm->layer_sizes[layer] > 0) {
					...
					memcpy(sprite_data->real_time_sprites.billboard_instance + frame_meta[frame].index_offset[layer] + pm->layer_sizes[layer], temp_sprites[layer].billboard_instance, sizeof(tfx_instance_t) * temp_sprites_buffer[layer].current_size);
					tfxU32 layer_offset = 0;
				...
				for (tfx_ribbon_bucket_t &bucket : pm->ribbon_segment_buckets.data) {
					...
					for (int emitter_index : bucket.control_ribbon_queue) {
						...
						for (tfxU32 ribbon_index : ribbon_emitter.ribbon_indexes[pm->current_ebuff]) {
							...
							id.age = tfxU32((bucket.ribbons.age[ribbon_index] + 0.1f) / pm->frame_length);
							TFX_ASSERT(ribbon_write_index < sprite_data->real_time_ribbons_buffer.capacity);
							sprite_data->real_time_ribbons.uid[ribbon_write_index] = id;
							ribbon_write_index++;
						}
					}
	...
	tfx__update_sprite_alignment_data(sprite_data, pm->update_time);

	for (tfxEachLayer) {
		tfx__free_soa_buffer(&temp_sprites_buffer[layer]);
	}

	// Copy ribbon segment data from buckets into shared_segments and remap start_index
	// This must happen before ClearEffectManager which frees bucket segment data
	if (total_ribbons > 0) {
		sprite_data->real_time_ribbons_buffer.current_size = total_ribbons;
		TFX_ASSERT(sprite_data->real_time_ribbons_buffer.current_size <= sprite_data->real_time_ribbons_buffer.capacity);
		tfx__reset_ribbon_data_lerp_offset(sprite_data);

		tfx_storage_map_t<tfxU32> bucket_segment_offsets;
		bucket_segment_offsets.init();
		bucket_segment_offsets.reserve(pm->ribbon_segment_buckets.Size());
		for (tfx_storage_map_t<tfx_ribbon_bucket_t>::pair &bucket_entry : pm->ribbon_segment_buckets.map) {
			tfx_ribbon_bucket_t &bucket = pm->ribbon_segment_buckets.data[bucket_entry.index];
			tfxU32 shared_offset = sprite_data->shared_segments.current_size;
			bucket_segment_offsets.Insert(bucket_entry.key, shared_offset);
			for (tfxU32 segment_index = 0; segment_index < bucket.segments.current_size; ++segment_index) {
				sprite_data->shared_segments.push_back_copy(bucket.segments[segment_index]);
			}
		}

		for (tfxU32 ribbon_index = 0; ribbon_index < sprite_data->real_time_ribbons_buffer.current_size; ++ribbon_index) {
			tfx_ribbon_t &ribbon = sprite_data->real_time_ribbons.ribbon_instance[ribbon_index];
			if (ribbon.start_index != tfxINVALID) {
				tfxU32 property_index = sprite_data->real_time_ribbons.uid[ribbon_index].property_index;
		...
		tfx__free_soa_buffer(&temp_ribbons_buffer);
	}
	...
	if (settings->playback_speed < 1.f) {
		tfx__compress_sprite_data(pm, effect, frame_length, progress);
		if (total_ribbons > 0) {
			tfx__compress_ribbon_data(sprite_data, settings, frame_length, progress);
		}
	}
	else {
		sprite_data->compressed_sprites = sprite_data->real_time_sprites;
		sprite_data->compressed_ribbons = sprite_data->real_time_ribbons;
		tfx__copy_soa_buffer(&sprite_data->compressed_sprites_buffer, &sprite_data->real_time_sprites_buffer);
		tfx__copy_soa_buffer(&sprite_data->compressed_ribbons_buffer, &sprite_data->real_time_ribbons_buffer);
		...
		sprite_data->compressed.ribbon_frame_meta.init();
		sprite_data->compressed.ribbon_frame_meta.copy(sprite_data->normal.ribbon_frame_meta);
		settings->frames_after_compression = sprite_data->normal.frame_count;
		if (total_ribbons > 0) {
			tfx__ribbon_data_set_captured_indexes(sprite_data);
		}
	}
...
void tfx__compress_sprite_data(tfx_effect_manager pm, tfx_effect_descriptor effect, float frame_length, int *progress) {
	*progress = tfxLinkUpSprites;
	...
	tfx__init_sprite_data_soa(&sprite_data->compressed_sprites_buffer, &sprite_data->compressed_sprites, tfxU32((float)sprite_data->real_time_sprites_buffer.current_size * sprite_data->frame_compression));
		...
		if (real_time >= compressed_time && frame_done == false) {
			for (tfxU32 i = tfx_SpriteDataIndexOffset(sprite_data, f, layer); i != tfx_SpriteDataEndIndex(sprite_data, f, layer); ++i) {
				...
				if (ci >= sprite_data->compressed_sprites_buffer.capacity) {
					bool result = tfx__grow_soa_arrays(&sprite_data->compressed_sprites_buffer, ci, sprite_data->compressed_sprites_buffer.capacity + 1, true);
	...
	*progress = tfxCompressSpriteFrames;
...
void tfx__compress_ribbon_data(tfx_sprite_data_t *sprite_data, tfx_sprite_data_settings_t *settings, float frame_length, int *progress) {
	*progress = tfxLinkUpRibbons;
	tfx__init_ribbon_data_soa(&sprite_data->compressed_ribbons_buffer, &sprite_data->compressed_ribbons, tfxU32((float)sprite_data->real_time_ribbons_buffer.current_size * sprite_data->frame_compression));

	sprite_data->compressed.ribbon_frame_meta.resize(tfxU32((float)settings->real_frames * settings->playback_speed) + 1);
	sprite_data->compressed.ribbon_frame_meta.zero();
	...
	//First pass, add the ribbon data from the real time data to the compressed data
	int f = 0;
	tfx_ribbon_data_soa_t &ribbons = sprite_data->real_time_ribbons;
	tfx_ribbon_data_soa_t &c_ribbons = sprite_data->compressed_ribbons;
	tfxU32 ci = 0;
	...
	do {
		...
		float lerp_offset = (next_compressed_time - real_time) / (next_compressed_time - compressed_time);
		if (real_time >= compressed_time && frame_done == false) {
			for (tfxU32 i = tfx_RibbonDataIndexOffset(sprite_data, f); i != tfx_RibbonDataEndIndex(sprite_data, f); ++i) {
				//Add all ribbons from this frame. Newly spawned ribbons (captured_index == tfxINVALID) get a lerp_offset for interpolation timing
				sprite_data->compressed.ribbon_frame_meta[compressed_frame].ribbon_count++;
				c_ribbons.uid[ci] = ribbons.uid[i];
				c_ribbons.lerp_offset[ci] = ribbons.ribbon_instance[i].captured_index == tfxINVALID ? lerp_offset : 1.f;
				c_ribbons.ribbon_instance[ci] = ribbons.ribbon_instance[i];
				ci++;
				if (ci >= sprite_data->compressed_ribbons_buffer.capacity) {
					bool result = tfx__grow_soa_arrays(&sprite_data->compressed_ribbons_buffer, ci, sprite_data->compressed_ribbons_buffer.capacity + 1, true);
					TFX_ASSERT(result);        //Failed to grow ribbon compression array
				}
			}
			frame_done = true;
			f++;
			...
			//For skipped frames between compressed frames, only add newly spawned ribbons
			for (tfxU32 i = tfx_RibbonDataIndexOffset(sprite_data, f); i != tfx_RibbonDataEndIndex(sprite_data, f); ++i) {
				if (ribbons.ribbon_instance[i].captured_index == tfxINVALID) {
					sprite_data->compressed.ribbon_frame_meta[compressed_frame].ribbon_count++;
					c_ribbons.uid[ci] = ribbons.uid[i];
					c_ribbons.lerp_offset[ci] = lerp_offset;
					c_ribbons.ribbon_instance[ci] = ribbons.ribbon_instance[i];
					ci++;
					if (ci >= sprite_data->compressed_ribbons_buffer.capacity) {
						bool result = tfx__grow_soa_arrays(&sprite_data->compressed_ribbons_buffer, ci, sprite_data->compressed_ribbons_buffer.capacity + 1, true);
			...
			sprite_data->compressed.ribbon_frame_meta[compressed_frame].index_offset = running_offset;
			running_offset += sprite_data->compressed.ribbon_frame_meta[compressed_frame].ribbon_count;
			start_frame = f;
			if (start_frame >= settings->real_frames) {
				finished = true;
			}
	...
	sprite_data->compressed.total_ribbons = ci;
	sprite_data->compressed_ribbons_buffer.current_size = ci;
	sprite_data->compressed.total_memory_for_ribbons = ci * (tfxU32)sprite_data->compressed_ribbons_buffer.struct_size;

	//Second pass, link up the captured indexes using the UIDs
	*progress = tfxCompressRibbonFrames;
	tfx__ribbon_data_set_captured_indexes(sprite_data);

	tfx__trim_soa_buffer(&sprite_data->compressed_ribbons_buffer);
	sprite_data->compressed.total_memory_for_ribbons = (tfxU32)sprite_data->compressed_ribbons_buffer.current_arena_size;
}
...
void tfx__update_sprite_alignment_data(tfx_sprite_data_t *sprite_data, float update_time) {
...
tfx_animation_manager tfx__create_animation_manager(tfxU32 max_instances) {
    ...
    animation_manager->sprite_data.set_alignment(16);
...
void tfx__add_effect_emitter_properties(tfx_animation_manager animation_manager, tfx_effect_descriptor effect, tfxU32 &ribbon_indexes, bool *has_animated_shape) {
	...
	if (effect->type == tfxEmitterType) {
		if (effect->library->emitter_properties[effect->state_properties.property_index].animation_property_index != tfxINVALID) {
			...
			properties.handle = effect->library->emitter_properties[effect->state_properties.property_index].image_handle;
		...
		if (ribbon_properties.animation_property_index != tfxINVALID) {
			...
			tfx_shared_properties_t &shared_properties = effect->library->shared_properties[effect->state_properties.shared_index];
...
void tfx_AddEffectShapes(tfx_animation_manager animation_manager, tfx_effect_descriptor effect) {
	...
	if (effect->type == tfxEmitterType || effect->type == tfxRibbonType) {
		tfx_image_data_t *image_data = effect->state_properties.image;
...
void tfx_AddSpriteData(tfx_animation_manager animation_manager, tfx_effect_descriptor effect, tfx_effect_manager pm, tfx_vec3_t camera_position) {
	...
	if (metrics.total_ribbons) {
		...
		for (int i = 0; i != metrics.total_ribbons; ++i) {
			tfx_ribbon_instance_data_t ribbon;
			memcpy(&ribbon, &ribbons.ribbon_instance[i], sizeof(tfx_ribbon_t));
			...
			ribbon.texture_indexes |= (tfxColorRampLayer(animation_manager->ribbon_properties[animation_property_index].color_ramp_index) << 16);
...
void tfx_UpdateAnimationManager(tfx_animation_manager animation_manager, float elapsed) {
	...
	for (auto i : animation_manager->instances_in_use[animation_manager->current_in_use_buffer]) {
		...
		if (instance.current_time >= instance.animation_length_in_time) {
			...
			if (metrics.ribbon_frame_meta.current_size > 0) {
				instance.ribbon_count = metrics.ribbon_frame_meta[frame].ribbon_count;
				instance.offset_into_ribbon_data = metrics.ribbon_frame_meta[frame].index_offset;
			} else {
				instance.ribbon_count = 0;
				instance.offset_into_ribbon_data = 0;
			}
...
void tfx_ResetAnimationManager(tfx_animation_manager animation_manager) {
	...
	animation_manager->ribbon_data.clear();
	animation_manager->ribbon_segment_data.clear();
	animation_manager->ribbon_graph_data.clear();
	animation_manager->ribbon_offsets.clear();
...
void tfx_UpdateAnimationManagerBufferMetrics(tfx_animation_manager animation_manager) {
	...
	animation_manager->buffer_metrics.ribbon_offsets_size = animation_manager->ribbon_offsets.current_size;
	...
	animation_manager->buffer_metrics.ribbon_offsets_size_in_bytes = animation_manager->buffer_metrics.ribbon_offsets_size * sizeof(tfxU32) * animation_manager->buffer_metrics.instances_size;
}

void tfx_RecordTemplateEffect(tfx_effect_template t, tfx_effect_manager pm, float update_frequency, float camera_position[3]) {
...
void *tfx_GetAnimationRibbonPropertiesBufferPointer(tfx_animation_manager animation_manager) {
	TFX_ASSERT_HANDLE(animation_manager);	//Not a valid animation manager handle
	return animation_manager->ribbon_properties.data;
}
...
void *tfx_GetAnimationRibbonDataBufferPointer(tfx_animation_manager animation_manager) {
	TFX_ASSERT_HANDLE(animation_manager);	//Not a valid animation manager handle
	return animation_manager->ribbon_data.data;
}
...
tfx_emitter_path_t *tfx_GetEmitterPath(tfx_effect_descriptor emitter) {
	if (emitter->state_properties.path_attributes != tfxINVALID) {
		TFX_ASSERT(emitter->library->paths.size() > emitter->state_properties.path_attributes); //The emitter path attributes is out of bounds. This really shouldn't happen, either a bug in the library or the path attributes was set manually and incorrectly.
		return &emitter->library->paths[emitter->state_properties.path_attributes];
	}
	return nullptr;
}
...
void tfx_SetTemplateEffectUpdateCallback(tfx_effect_template t, void(*update_callback)(tfx_effect_manager pm, tfxEffectID effect_index)) {
	TFX_ASSERT_HANDLE(t);	//Not a valid tfx_effect_template handle. Use tfx_CreateEffectTemplate to create a new template.
	t->effect->update_callback = update_callback;
}

bool tfx_AddEffectTemplateToEffectManager(tfx_effect_manager pm, tfx_effect_template effect_template, tfxEffectID *effect_id) {
	TFX_ASSERT_HANDLE(pm);				//Not a valid particle manager handle
	...
	tfxEffectID id;
	id = tfx__add_effect_to_effect_manager(pm, effect_template->effect, pm->current_ebuff, 0, 0.f);
	if (effect_id) {
		*effect_id = id;
	}
...
bool tfx_AddRawEffectToEffectManager(tfx_effect_manager pm, tfx_effect_descriptor effect, tfxEffectID *effect_id) {
	TFX_ASSERT_HANDLE(pm);				//Not a valid particle manager handle
	tfxEffectID id;
	id = tfx__add_effect_to_effect_manager(pm, effect, pm->current_ebuff, 0, 0.f);
	if (effect_id) {
		*effect_id = id;
	}
	return id != tfxINVALID;
...
tfxEffectID tfx__add_effect_to_effect_manager(tfx_effect_manager pm, tfx_effect_descriptor effect, int buffer, tfxU32 root_effect_index, float add_delayed_spawning) {
	...
	new_effect.property_flags = effect->state_properties.property_flags;
	...
	for (tfx_effect_descriptor child : effect->children) {
		if (child->state_properties.shared_flags & tfxSharedEmitterPropertyFlags_enabled && !(child->state_properties.shared_flags & tfxSharedEmitterPropertyFlags_hidden)) {
			...
			if (child->type == tfxEmitterType) {
				...
				tfx_emitter_bucket_t *bucket = tfx__get_emitter_bucket(pm, child, shared_properties);
				if (!bucket) {
					break;
				}
				tfx_particle_emitter_state_t &emitter = bucket->emitter_states[pm->current_ebuff].push_back({});
				tfx__readbarrier;
				emitter.particles_index = tfxINVALID;
				emitter.parent_index = parent_index.index;
				tfx_particle_emitter_properties_t *emitter_properties = tfx__get_particle_emitter_properties(child);
				...
				state_flags |= child->state_properties.shared_flags & tfxSharedEmitterPropertyFlags_single && !(pm->flags & tfxEffectManagerFlags_disable_spawning) ? tfxEmitterStateFlags_is_single : 0;
				...
				state_flags |= shared_properties->emission_type == tfxLine && property_flags & tfxEmitterPropertyFlags_edge_traversal ? tfxEmitterStateFlags_is_edge_traversal : 0;
				state_flags |= shared_properties->emission_type == tfxPath && property_flags & tfxEmitterPropertyFlags_edge_traversal ? tfxEmitterStateFlags_is_edge_traversal : 0;
				...
				if (emitter.state_properties.property_flags & tfxEmitterPropertyFlags_run_on_gpu) {
					...
					tfx__assign_emitter_to_gpu_group(pm, bucket);
				}
				...
				tfxEmitterStateFlags &state_flags = ribbon_emitter.state_flags;
				const tfxEmitterStateFlags &parent_state_flags = new_effect.state_flags;
				if (shared_properties->emission_type == tfxPath) {
					tfx_emitter_path_t *path = &ribbon_emitter.library->paths[ribbon_emitter.state_properties.path_attributes];
			...
			/*if (pm->flags & tfxEffectManagerFlags_use_compute_shader && tfx_GetEffectInfo(child)->children.empty()) {
...
void tfx__update_emitter_control_profile(tfx_effect_descriptor emitter) {
	...
	if (shared_properties->emission_type == tfxPath) {
		...
		if (path) {
			if (path->settings.rotation_range || path->settings.rotation_pitch || path->settings.rotation_yaw) {
				emitter->state_properties.control_profile |= tfxEmitterControlProfile_rotated_path;
			}
		}
	}
	...
	if (emitter->state_properties.property_flags & tfxEmitterPropertyFlags_edge_traversal && (shared_properties->emission_type == tfxPath || shared_properties->emission_type == tfxLine)) {
		emitter->state_properties.control_profile |= tfxEmitterControlProfile_edge_traversal;
		if (emitter_properties->end_behaviour == tfxLoop) {
			emitter->state_properties.control_profile |= tfxEmitterControlProfile_edge_loop;
		}
		else if (emitter_properties->end_behaviour == tfxKill) {
			emitter->state_properties.control_profile |= tfxEmitterControlProfile_edge_kill;
		}
	}
	if (tfx__get_graph_max_value(&emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxEmitter_overtime_stretch_index])) {
		emitter->state_properties.control_profile |= tfxEmitterControlProfile_stretch;
	}
	if (shared_properties->emission_type == tfxLine) {
		if (tfx__has_emission_range(emitter)) {
			emitter->state_properties.control_profile |= tfxEmitterControlProfile_rotated_line;
		} else {
			emitter->state_properties.control_profile |= tfxEmitterControlProfile_line;
		}
	}
	if (emitter->state_properties.property_flags & tfxEmitterPropertyFlags_use_path_as_trajectory && (shared_properties->emission_type == tfxPath || shared_properties->emission_type == tfxLine)) {
		emitter->state_properties.control_profile |= tfxEmitterControlProfile_trajectory;
	}
	bool spin_3d = (emitter_properties->billboard_option == tfxBillboarding_free_align || emitter_properties->billboard_option == tfxBillboarding_align_to_vector);
	if (spin_3d) {
		float max_roll_spin = tfx__get_graph_max_value(&emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxEmitter_overtime_roll_spin_index]);
		float max_pitch_spin = tfx__get_graph_max_value(&emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxEmitter_overtime_pitch_spin_index]);
		float max_yaw_spin = tfx__get_graph_max_value(&emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxEmitter_overtime_yaw_spin_index]);
		max_roll_spin *= (	tfx__get_graph_max_value(&emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxEmitter_base_roll_spin_index]) +
							tfx__get_graph_max_value(&emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxEmitter_variation_roll_spin_index]));
		max_pitch_spin *= (	tfx__get_graph_max_value(&emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxEmitter_base_pitch_spin_index]) +
							tfx__get_graph_max_value(&emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxEmitter_variation_pitch_spin_index]));
		max_yaw_spin *= (	tfx__get_graph_max_value(&emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxEmitter_base_yaw_spin_index]) + 
							tfx__get_graph_max_value(&emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxEmitter_variation_yaw_spin_index]));
		if (max_roll_spin != 0.f || max_pitch_spin != 0.f || max_yaw_spin != 0.f) {
			emitter->state_properties.control_profile |= tfxEmitterControlProfile_spin3d;
		}
	} else {
		float max_roll_spin = tfx__get_graph_max_value(&emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxEmitter_overtime_roll_spin_index]);
		max_roll_spin *= (	tfx__get_graph_max_value(&emitter->library->graphs[emitter->state_properties.graph_list_index].graphs[tfxEmitter_base_roll_spin_index]) +
		...
		if (max_roll_spin != 0.f) {
			emitter->state_properties.control_profile |= tfxEmitterControlProfile_spin;
		}
	}
}

int tfx__add_compute_controller(tfx_effect_manager pm) {
...
void tfx__reset_particle_ptr(tfx_effect_manager pm, void *ptr) {
	pm->new_compute_particle_ptr = ptr;
	pm->new_compute_particle_index = 0;
}

void tfx__reset_controller_ptr(tfx_effect_manager pm, void *ptr) {
	pm->compute_controller_ptr = ptr;
}

void tfx__update_compute(tfx_effect_manager pm, void *sampled_particles, unsigned int sample_size) {
...
tfx_compute_particle_t *tfx__grab_compute_particle(tfx_effect_manager pm, unsigned int layer) {
...
void tfx__free_particle_list(tfx_effect_manager pm, tfxU32 index) {
	if (pm->free_particle_lists.ValidKey(pm->emitters[index].source_emitter->path_hash) && pm->emitters[index].particles_index != tfxINVALID) {
		...
		tfx_vector_t<tfxU32> &new_indexes = pm->free_particle_lists.At(pm->emitters[index].source_emitter->path_hash);
		new_indexes.push_back(pm->emitters[index].particles_index);
		pm->emitters[index].particles_index = tfxINVALID;
	}
}

void tfx__free_spawn_location_list(tfx_effect_manager pm, tfxU32 index) {
	if (pm->free_particle_location_lists.ValidKey(pm->emitters[index].source_emitter->path_hash) && pm->emitters[index].spawn_locations_index != tfxINVALID) {
		tfx__clear_soa_buffer(&pm->particle_location_buffers[pm->emitters[index].spawn_locations_index]);
		pm->free_particle_location_lists.At(pm->emitters[index].source_emitter->path_hash).push_back(pm->emitters[index].spawn_locations_index);
	}
	else if (pm->emitters[index].spawn_locations_index != tfxINVALID) {
		pm->free_particle_location_lists.Insert(pm->emitters[index].source_emitter->path_hash, {});
		tfx_vector_t<tfxU32> &new_indexes = pm->free_particle_location_lists.At(pm->emitters[index].source_emitter->path_hash);
		tfx__clear_soa_buffer(&pm->particle_location_buffers[pm->emitters[index].spawn_locations_index]);
		new_indexes.push_back(pm->emitters[index].spawn_locations_index);
	}
}

void tfx__order_effect_sprites(tfx_effect_instance_data_t *sprites, tfxU32 layer, tfx_effect_manager pm) {
	...
	if (depth_starting_index < current_depth_indexes.current_size) {
		...
		qsort(&current_depth_indexes[depth_starting_index], current_depth_indexes.current_size - depth_starting_index, sizeof(tfx_depth_index_t), tfx__sort_depth);
...
void tfx__update_effect_manager(void *data) {
	...
	tfxU32 effects_start_size = pm->effects_in_use[pm->current_ebuff].current_size;
	...
	for (tfx_emitter_bucket bucket : pm->emitter_buckets) {
		...
		spawn_work_entry->bucket = bucket;
		spawn_work_entry->next_buffer = next_buffer;
		tfx_library library = pm->emitters[emitter_index].library;
		spawn_work_entry->properties = &library->emitter_properties[bucket->state_properties.property_index];
		spawn_work_entry->shared_properties = &library->shared_properties[bucket->state_properties.shared_index];
		...
		tfx__add_work_queue_entry(&pm->work_queue, spawn_work_entry, tfx__update_bucket);
...
*/
		...
		if (effect.effect_flags & tfxEffectPropertyFlags_depth_draw_order) {
			if (effect.effect_flags & tfxEffectPropertyFlags_guaranteed_order) {
				...
				for (tfxEachLayer) {
					...
					for (tfxU32 sorts = 0; sorts != effect.sort_passes; ++sorts) {
						for (tfxU32 i = 1; i < depth_index.current_size; ++i) {
							...
							if (depth1 < depth2) {
								...
								tfx__swap_depth_index(&depth_index[i], &depth_index[i - 1]);
							}
						}
					}
				}
	...
	if (pm->flags & tfxEffectManagerFlags_update_bounding_boxes) {
		for (int i = 0; i != pm->effects_in_use[pm->current_ebuff].size(); ++i) {
			tfx_effect_index_t effect_index = pm->effects_in_use[pm->current_ebuff][i];
			tfx_effect_state_t &effect = pm->effects[effect_index.index];
		...
		for (int i = 0; i != pm->effects_in_use[pm->current_ebuff].size(); ++i) {
			...
			for (tfxU32 emitter_index : effect.emitter_indexes[pm->current_ebuff]) {
				...
				tfx_bounding_box_t &effect_bb = pm->effects[emitter.parent_index].bounding_box;
...
void tfx_GetSpriteHandle(void *instance, float out_handle[2]) {
	tfx_instance_t *sprite = static_cast<tfx_instance_t *>(instance);
...
void tfx_GetCapturedInstanceTransform(tfx_effect_manager pm, tfxU32 layer, tfxU32 index, float out_position[3]) {
	TFX_ASSERT_HANDLE(pm);		//Not a valid effect manager
...
tfxU32 tfx_RibbonDataIndexOffset(tfx_sprite_data_t *sprite_data, tfxU32 frame) {
	TFX_ASSERT(frame < sprite_data->normal.ribbon_frame_meta.size());            //frame is outside index range
	return sprite_data->normal.ribbon_frame_meta[frame].index_offset;
}
...
tfxU32 tfx_RibbonDataEndIndex(tfx_sprite_data_t *sprite_data, tfxU32 frame) {
	TFX_ASSERT(frame < sprite_data->normal.ribbon_frame_meta.size());            //frame is outside index range
...
tfxU32 tfx_GetTotalRibbonsThatNeedDrawing(tfx_animation_manager animation_manager) {
	return animation_manager->buffer_metrics.total_ribbons_to_draw;
}
...
void *tfx_GetRibbonDataBufferPointer(tfx_animation_manager animation_manager) {
	return animation_manager->ribbon_data.data;
}

size_t tfx_GetOffsetsSizeInBytes(tfx_animation_manager animation_manager) {
	return animation_manager->offsets.size_in_bytes();
}

void *tfx_GetOffsetsBufferPointer(tfx_animation_manager animation_manager) {
	return animation_manager->offsets.data;
}

void *tfx_GetRibbonOffsetsBufferPointer(tfx_animation_manager animation_manager) {
	return animation_manager->ribbon_offsets.data;
}

size_t tfx_GetRibbonOffsetsSizeInBytes(tfx_animation_manager animation_manager) {
	return animation_manager->ribbon_offsets.size_in_bytes();
}
...
size_t tfx_GetAnimationRibbonPropertySizeInBytes(tfx_animation_manager animation_manager) {
	return animation_manager->ribbon_properties.size_in_bytes();
}
...
size_t tfx_GetAnimationRibbonDataSizeInBytes(tfx_animation_manager animation_manager) {
	return animation_manager->ribbon_data.size_in_bytes();
}
...
void tfx_FreeGPUShapesList(tfx_gpu_shapes shapes) {
	TFX_ASSERT_HANDLE(shapes);	//This shapes pointer is not initialised! Call tfx_CreateGPUShapesList to create a valid handle.
	shapes->list.free();
	tfxFREE(shapes);
}
...
size_t tfx_GetSpriteDataSizeInBytes(tfx_animation_manager animation_manager) {
	return animation_manager->sprite_data.size_in_bytes();
}

size_t tfx_GetRibbonDataSizeInBytes(tfx_animation_manager animation_manager) {
	return animation_manager->ribbon_data.size_in_bytes();
}
...
tfxAPI tfx_effect_descriptor tfx_NewEffectDescriptor(tfx_effect_descriptor_type type) {
	...
	*new_effect = blank_effect;
	...
	new_effect->state_properties.property_index = tfxINVALID;
	...
	new_effect->state_properties.control_profile = 0;
	new_effect->state_properties.angle_offsets = { 0.f, 0.f, tfx360Radians };
	...
	new_effect->state_properties.shared_flags = tfxSharedEmitterPropertyFlags_grid_spawn_clockwise | tfxSharedEmitterPropertyFlags_emitter_handle_auto_center;
	new_effect->state_flags = 0;
	return new_effect;
}
...
void tfx__control_particle_capture_spawn_locations(tfx_work_queue_t *queue, void *data) {
	...
	for (tfxU32 i = work_entry->start_index; i != work_entry->wide_end_index; i += tfxDataWidth) {
		...
		tfxWideFloat position_x = tfxWideLoad(&bank.position_x[index]);
		...
		if (transform_relative) {
			...
			position_x = tfxWideAdd(tfxWideMul(position_x, e_scale), e_world_position_x);
			position_y = tfxWideAdd(tfxWideMul(position_y, e_scale), e_world_position_y);
			position_z = tfxWideAdd(tfxWideMul(position_z, e_scale), e_world_position_z);
		}
		else if (shared_flags & tfxSharedEmitterPropertyFlags_relative_position && emission_type == tfxPath) {
			tfx__wide_transform_quaternion_vec3(&emitter.rotation, &position_x, &position_y, &position_z);
			position_x = tfxWideAdd(tfxWideMul(position_x, e_scale), e_world_position_x);
			position_y = tfxWideAdd(tfxWideMul(position_y, e_scale), e_world_position_y);
			position_z = tfxWideAdd(tfxWideMul(position_z, e_scale), e_world_position_z);
		} else if (shared_flags & tfxSharedEmitterPropertyFlags_relative_position && emission_type == tfxOtherEmitter) {
			position_x = tfxWideMul(position_x, e_scale);
			position_y = tfxWideMul(position_y, e_scale);
			position_z = tfxWideMul(position_z, e_scale);
		}

		tfx_spawn_points_soa_t &locations = work_entry->pm->particle_location_arrays[emitter.spawn_locations_index];
		tfxWideStore(&locations.captured_position_x[index], position_x);
		tfxWideStore(&locations.captured_position_y[index], position_y);
		tfxWideStore(&locations.captured_position_z[index], position_z);
	}
}
...
void tfx_setup_path_policy::apply(tfx_control_work_entry_t *work_entry, tfx_position_policy_context &ctx) {
	...
	TFX_ASSERT(ctx.emitter->state_properties.path_attributes != tfxINVALID);
	ctx.path = &ctx.emitter->library->paths[ctx.emitter->state_properties.path_attributes];
	...
	ctx.velocity_adjuster = tfxWideSetSingle(tfx__sample_multi_node_graph(&ctx.emitter->library->graphs[ctx.emitter->state_properties.graph_list_index].graphs[tfxEmitter_overtime_velocity_adjuster_index], ctx.emitter->age, ctx.emitter->oscillator_time));
...
void tfx_setup_line_policy::apply(tfx_control_work_entry_t *work_entry, tfx_position_policy_context &ctx) {
	tfxU32 emitter_index = work_entry->emitter_index;
	tfx_effect_manager_t &pm = *work_entry->pm;
	ctx.emitter = &pm.emitters[emitter_index];
	ctx.emitter_height = tfxWideSetSingle(ctx.emitter->emitter_size.y);
...
void tfx_setup_transform_policy::apply(tfx_control_work_entry_t *work_entry, tfx_position_policy_context &ctx) {
	...
	const tfxSharedEmitterFlags shared_flags = ctx.emitter->state_properties.shared_flags;
...
TFX_DISABLE_COMPILER_WARNING("-Walign-mismatch")
	ctx.flags |= tfx__is_ordered_effect_state(&work_entry->pm->effects[ctx.emitter->parent_index]) ? tfx_ctx_policy_flag_is_ordered : 0;
TFX_ENABLE_COMPILER_WARNING()
...
void tfx__update_particles_position(tfx_control_work_entry_t *work_entry, tfx_position_policy_context &ctx) {
	...
	ctx.overal_scale_wide = tfxWideSetSingle(work_entry->overal_scale);
	ctx.velocity_adjuster = tfxWideSetSingle(tfx__sample_multi_node_graph(&library->graphs[ctx.emitter->state_properties.graph_list_index].graphs[tfxEmitter_overtime_velocity_adjuster_index], ctx.emitter->age, ctx.emitter->oscillator_time));
...
void tfx__control_ribbons(tfx_work_queue_t *queue, void *data) {
	...
	tfx_ribbon_bucket_t *ribbon_bucket = work_entry->ribbon_bucket;
	tfx_effect_manager pm = work_entry->pm;
	for (int index : ribbon_bucket->control_ribbon_queue) {
...
void tfx__control_ribbon_attributes(tfx_work_queue_t *queue, void *data) {
	tfxPROFILE;
	tfx_control_ribbon_work_entry_t *work_entry = static_cast<tfx_control_ribbon_work_entry_t *>(data);
	tfxU32 ribbon_index = work_entry->ribbon_index;
	tfx_effect_manager_t &pm = *work_entry->pm;
	tfx_ribbon_emitter_state_t &ribbon_emitter = pm.ribbon_emitters[ribbon_index];
	tfx_shared_properties_t &shared_properties = ribbon_emitter.library->shared_properties[ribbon_emitter.state_properties.shared_index];
	...
	tfx_bucket_state_properties_t &state_properties = ribbon_emitter.state_properties;
	float frames = state_properties.end_frame + 1.f;
	...
	for (tfxU32 ribbon_index : ribbon_emitter.ribbon_indexes[pm.current_ebuff]) {
		...
		float intensity_time = intensity_easing(age_lerp);
		float lookup_intensity = intensity_is_bezier_graph ?	
			tfx__bezier_sampler(intensity_time, intensity_graph->nodes[0].value, intensity_graph->nodes[0].right.y, intensity_graph->nodes[1].left.y, intensity_graph->nodes[1].value) :
			tfx__linear_sampler(intensity_graph->nodes[0].value, intensity_graph->nodes[1].value, intensity_time);

		float curved_alpha_time = curved_alpha_easing(age_lerp);
		float lookup_curved_alpha = curved_alpha_is_bezier_graph ?	
			tfx__bezier_sampler(curved_alpha_time, curved_alpha_graph->nodes[0].value, curved_alpha_graph->nodes[0].right.y, curved_alpha_graph->nodes[1].left.y, curved_alpha_graph->nodes[1].value) :
			tfx__linear_sampler(curved_alpha_graph->nodes[0].value, curved_alpha_graph->nodes[1].value, curved_alpha_time);

		float alpha_sharpness_time = alpha_sharpness_easing(age_lerp);
		float lookup_alpha_sharpness = alpha_sharpness_is_bezier_graph ?	
			tfx__bezier_sampler(alpha_sharpness_time, alpha_sharpness_graph->nodes[0].value, alpha_sharpness_graph->nodes[0].right.y, alpha_sharpness_graph->nodes[1].left.y, alpha_sharpness_graph->nodes[1].value) :
			tfx__linear_sampler(alpha_sharpness_graph->nodes[0].value, alpha_sharpness_graph->nodes[1].value, alpha_sharpness_time);

		float gradient_mapper_time = (ribbon_emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_random_color) ? random_age : gradient_mapper_easing(age_lerp);
		float lookup_gradient_mapper = gradient_mapper_is_bezier_graph ?	
			tfx__bezier_sampler(gradient_mapper_time, gradient_mapper_graph->nodes[0].value, gradient_mapper_graph->nodes[0].right.y, gradient_mapper_graph->nodes[1].left.y, gradient_mapper_graph->nodes[1].value) :
			tfx__linear_sampler(gradient_mapper_graph->nodes[0].value, gradient_mapper_graph->nodes[1].value, gradient_mapper_time);

		if (intensity_has_oscillator) {
			lookup_intensity *= (tfxOSCILLATOR_SIN(intensity_graph->oscillator.offset_x + intensity_time, intensity_graph->oscillator.frequency, intensity_graph->oscillator.amplitude) + intensity_graph->oscillator.offset_y);
		}

		if (curved_alpha_has_oscillator) {
			lookup_curved_alpha *= (tfxOSCILLATOR_SIN(curved_alpha_graph->oscillator.offset_x + curved_alpha_time, curved_alpha_graph->oscillator.frequency, curved_alpha_graph->oscillator.amplitude) + curved_alpha_graph->oscillator.offset_y);
		}

		if (alpha_sharpness_has_oscillator) {
			lookup_alpha_sharpness *= (tfxOSCILLATOR_SIN(alpha_sharpness_graph->oscillator.offset_x + alpha_sharpness_time, alpha_sharpness_graph->oscillator.frequency, alpha_sharpness_graph->oscillator.amplitude) + alpha_sharpness_graph->oscillator.offset_y);
		}

		if (gradient_mapper_has_oscillator) {
			lookup_gradient_mapper *= (tfxOSCILLATOR_SIN(gradient_mapper_graph->oscillator.offset_x + gradient_mapper_time, gradient_mapper_graph->oscillator.frequency, gradient_mapper_graph->oscillator.amplitude) + gradient_mapper_graph->oscillator.offset_y);
		}

		ribbon.intensity_gradient_map = tfx__pack16bit_sscaled(lookup_intensity, lookup_gradient_mapper, 128.f);
		ribbon.curved_alpha = tfx__pack16bit_sscaled(lookup_curved_alpha, lookup_alpha_sharpness, 128.f);

		image_frame += ribbon_emitter.state_properties.image_frame_rate * pm.update_time;
		if (ribbon_emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_reverse_animation && ribbon_emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_play_once) {
			image_frame = state_properties.end_frame - image_frame;
			image_frame = tfx__Max(image_frame, 0.f);
		} else if (ribbon_emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_play_once) {
			image_frame = tfx__Min(image_frame, state_properties.end_frame);
		} else if (ribbon_emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_reverse_animation) {
...
void tfx__control_ribbons_ages(tfx_work_queue_t *queue, void *data) {
	tfxPROFILE;
	tfx_control_ribbon_work_entry_t *work_entry = static_cast<tfx_control_ribbon_work_entry_t *>(data);
	for (int index : work_entry->ribbon_bucket->control_ribbon_queue) {
		tfx_ribbon_emitter_state_t &ribbon_emitter = work_entry->pm->ribbon_emitters[index];
		work_entry->ribbon_index = index;
		if (ribbon_emitter.active_ribbons > 0) {
			tfx__control_ribbon_path_age(queue, work_entry);
		}
	}
}

void tfx__control_ribbon_path_age(tfx_work_queue_t *queue, void *data) {
	tfxPROFILE;
	tfx_control_ribbon_work_entry_t *work_entry = static_cast<tfx_control_ribbon_work_entry_t *>(data);
	tfxU32 ribbon_index = work_entry->ribbon_index;
	tfx_effect_manager_t &pm = *work_entry->pm;
	...
	tfx_shared_properties_t *shared_properties = &library->shared_properties[ribbon_emitter.state_properties.shared_index];

	//There must be a path setup for the emitter.
	TFX_ASSERT(ribbon_emitter.state_properties.path_attributes != tfxINVALID);
	tfx_emitter_path_t *path = &library->paths[ribbon_emitter.state_properties.path_attributes];
	...
	for (tfxU32 ribbon_index : ribbon_emitter.ribbon_indexes[pm.current_ebuff]) {
		...
		float &max_age = bucket->ribbons.max_age[ribbon_index];
		age += pm.frame_length;
		if (age > max_age && ribbon_emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_single) {
...
void tfx__control_particle_spin_roll(tfx_work_queue_t *queue, void *data) {
	...
	bool relative_position = emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_relative_position || (emitter.state_properties.property_flags & tfxEmitterPropertyFlags_edge_traversal && emission_type == tfxLine);
TFX_DISABLE_COMPILER_WARNING("-Walign-mismatch")
	bool is_ordered = tfx__is_ordered_effect_state(&pm.effects[emitter.parent_index]);
TFX_ENABLE_COMPILER_WARNING()
	...
	tfxU32 start_index = tfx__get_circular_index(&work_entry->pm->particle_array_buffers[emitter.particles_index], work_entry->start_index) / tfxDataWidth * tfxDataWidth;
	tfxU32 end_index = tfx__get_circular_index(&work_entry->pm->particle_array_buffers[emitter.particles_index], work_entry->wide_end_index) / tfxDataWidth * tfxDataWidth;
...
#ifdef tfxHALFFLOATS
			tfx128i half_base_roll_spin = tfxWideLoadHalfs(&bank.base_roll_spin[index]);
			tfx128i half_base_pitch_spin = tfxWideLoadHalfs(&bank.base_pitch_spin[index]);
			tfx128i half_base_yaw_spin = tfxWideLoadHalfs(&bank.base_yaw_spin[index]);
			tfxWideFloat base_roll_spin = tfxWideConvertHalfsToFloats(half_base_roll_spin);
			tfxWideFloat base_pitch_spin = tfxWideConvertHalfsToFloats(half_base_pitch_spin);
			tfxWideFloat base_yaw_spin = tfxWideConvertHalfsToFloats(half_base_yaw_spin);
#else
			tfxWideFloat base_roll_spin = tfxWideLoad(&bank.base_roll_spin[index]);
	...
	for (tfxU32 i = work_entry->start_index; i != work_entry->wide_end_index; i += tfxDataWidth) {
		...
		if (is_ordered) {    //Predictable
			for (tfxU32 j = start_diff; j < tfxMin(limit_index + start_diff, tfxDataWidth); ++j) {
				tfxU32 sprite_depth_index = bank.depth_index[index + j] + work_entry->cumulative_index_point + work_entry->effect_instance_offset;
				TFX_ASSERT(sprite_depth_index < work_entry->sprite_instances->current_size);
				sprites[sprite_depth_index].size_handle.packed = emitter.state_properties.image_handle_packed;
				running_sprite_index++;
			}
		}
		else {
			for (tfxU32 j = start_diff; j < tfxMin(limit_index + start_diff, tfxDataWidth); ++j) {
				TFX_ASSERT(running_sprite_index < work_entry->sprite_instances->current_size);
				sprites[running_sprite_index].size_handle.packed = emitter.state_properties.image_handle_packed;
				running_sprite_index++;
			}
		}
		start_diff = 0;
	...
	for (tfxU32 i = work_entry->start_index; i != work_entry->wide_end_index; i += tfxDataWidth) {
...
#ifdef tfxHALFFLOATS
		tfx128i half_base_size_x = tfxWideLoadHalfs(&bank.base_size_x[index]);
		tfx128i half_base_size_y = tfxWideLoadHalfs(&bank.base_size_y[index]);
		tfxWideFloat base_size_x = tfxWideConvertHalfsToFloats(half_base_size_x);
		tfxWideFloat base_size_y = tfxWideConvertHalfsToFloats(half_base_size_y);
#else
		...
		if (is_ordered) {    //Predictable
			for (tfxU32 j = start_diff; j < tfxMin(limit_index + start_diff, tfxDataWidth); ++j) {
				tfxU32 sprite_depth_index = bank.depth_index[index + j] + work_entry->cumulative_index_point + work_entry->effect_instance_offset;
				TFX_ASSERT(sprite_depth_index < work_entry->sprite_instances->current_size);
				sprites[sprite_depth_index].size_handle.packed = packed_scale.a[j] | emitter.state_properties.image_handle_packed;
				running_sprite_index++;
			}
		}
		else {
			for (tfxU32 j = start_diff; j < tfxMin(limit_index + start_diff, tfxDataWidth); ++j) {
				...
				scale_handle.packed = packed_scale.a[j] | emitter.state_properties.image_handle_packed;
...
void tfx__control_particle_color(tfx_work_queue_t *queue, void *data) {
	...
	tfx_color_ramp_t &ramp = work_entry->graphs->color_ramps;
	tfxWideFloat life;
...
TFX_DISABLE_COMPILER_WARNING("-Walign-mismatch")
	bool is_ordered = tfx__is_ordered_effect_state(&pm->effects[emitter.parent_index]);
TFX_ENABLE_COMPILER_WARNING()
	bool is_mixed_color = emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_use_color_hint;
...
TFX_ENABLE_COMPILER_WARNING()
	...
	for (tfxU32 i = work_entry->start_index; i != work_entry->wide_end_index; i += tfxDataWidth) {
		...
		image_indexes.m = tfxWideOri(color_ramp_indexes, tfxWideAddi(tfxWideConverti(image_frame), image_start_index));

		tfxU32 limit_index = running_sprite_index + tfxDataWidth > work_entry->sprite_buffer_end_index ? work_entry->sprite_buffer_end_index - running_sprite_index : tfxDataWidth;
		tfx_instance_t *sprites = tfxCastBuffer(tfx_instance_t, work_entry->sprite_instances);
		if (is_ordered) {
			tfx__write_particle_image_sprite_data_ordered(sprites, pm, layer, start_diff, limit_index, bank, flags, image_indexes, emitter.state_flags, billboard_option, index, running_sprite_index, work_entry->effect_instance_offset + work_entry->cumulative_index_point);
		} else {
			tfx__write_particle_image_sprite_data(sprites, pm, layer, start_diff, limit_index, bank, flags, image_indexes, emitter.state_flags, billboard_option, index, running_sprite_index);
		}
...
void tfx_SetSeed(tfx_effect_manager pm, tfxU64 seed) {
...
tfx_ribbon_buffer_info_t tfx_GetRibbonBufferInfo(tfx_effect_manager pm, tfxKey bucket_hash) {
...
tfx_ribbon_dispatch_t tfx_CreateRibbonDispatch() {
	return {};
}

void tfx__reset_ribbon_buffer_requirements(tfx_effect_manager pm) {
	...
	while (bucket) {
		bucket->highest_ribbon_index = 0;
		bucket->lowest_ribbon_index = tfxINVALID;
		bucket->highest_segment_index = 0;
		bucket->lowest_segment_index = tfxINVALID;
		bucket = pm->ribbon_segment_buckets.next_item();
	}
}

void tfx__update_ribbon_buffer_requirements(tfx_effect_manager pm) {
	tfx_ribbon_bucket_t *bucket = pm->ribbon_segment_buckets.next_item();
	while (bucket) {
		...
		pm->ribbon_buffer_requirements.segment_buffer_size_in_bytes += segment_count * sizeof(tfx_ribbon_segment_t);
...
void tfx_ResetRibbonDispatchIterator(tfx_effect_manager pm) {
	pm->ribbon_segment_buckets.iterator_index = 0;
}

tfx_effect_manager tfx__next_global_effect_manager() {
	tfx_effect_manager *next_pm = tfxStore->effect_managers.next_item();
...
tfx_ribbon_buffer_requirements_t tfx_GetRibbonBufferRequirements() {
	...
	while (pm) {
		...
		pm = tfx__next_global_effect_manager();
	}
...
size_t tfx_GetSegmentBufferMaxSizeInBytes(tfx_effect_manager pm) {
	return pm->info.max_ribbon_segments * sizeof(tfx_ribbon_segment_t);
}
...
void tfx_SetPMWorkQueueSizes(tfx_effect_manager pm, tfxU32 spawn_work_max, tfxU32 control_work_max, tfxU32 age_work_max) {
	...
	pm->ribbon_work.reserve(spawn_work_max);
...
void tfx_ClearEffectManager(tfx_effect_manager pm, bool free_particle_banks, bool free_sprite_buffers) {
	...
	if (free_particle_banks) {
		...
		for (tfx_effect_index_t index : pm->effects_in_use[pm->current_ebuff]) {
	...
	pm->effects_in_use[0].clear();
	pm->effects_in_use[1].clear();
	pm->control_emitter_queue.clear();
...
void tfx_FreeEffectManager(tfx_effect_manager pm) {
	...
	for (tfx_ribbon_bucket_t &bucket : pm->ribbon_segment_buckets.data) {
		...
		tfx__free_soa_buffer(&bucket.ribbons_buffer);
		bucket.segments.free();
...
void tfx__free_all_particle_lists(tfx_effect_manager pm) {
...
void tfx_KeepBoundingBoxesUpdated(tfx_effect_manager pm, bool yesno) {
	if (yesno) {
...
void tfx_UpdatePMBaseValues(tfx_effect_manager pm) {
	pm->flags |= tfxEffectManagerFlags_update_base_values;
}

bool tfx__free_pm_effect_capacity(tfx_effect_manager pm) {
	return pm->effects.current_size < pm->max_effects;
}

tfx_effect_index_t tfx__get_effect_slot(tfx_effect_manager pm) {
...
tfx_emitter_bucket tfx__new_emitter_bucket() {
	tfx_emitter_bucket_t blank = {};
	tfx_emitter_bucket bucket = tfxNEW_ALIGNED(tfx_emitter_bucket, 16);
	*bucket = blank;
}

tfx_emitter_bucket_t *tfx__get_emitter_bucket(tfx_effect_manager pm, tfx_effect_descriptor emitter, tfx_shared_properties_t *shared_properties) {
	if (!pm->emitter_buckets.ValidKey(emitter->path_hash)) {
		tfx_emitter_bucket bucket = tfx__new_emitter_bucket();
		bucket->state_properties = emitter->state_properties;
		bucket->state_properties.image_frame_rate = emitter->state_properties.image->animation_frames > 1 && emitter->state_properties.shared_flags & tfxSharedEmitterPropertyFlags_animate ? shared_properties->frame_rate : 0.f;
		bucket->source_emitter = emitter;
		bucket->library = emitter->library;
		bucket->particles_index = tfx__grab_particle_lists(pm, emitter->path_hash, 100, emitter->state_properties.control_profile);
		pm->emitter_buckets.Insert(emitter->path_hash, bucket);
		TFX_ASSERT(bucket->particles_index != tfxINVALID);
		return bucket;
	}
	return &pm->emitter_buckets.At(emitter->path_hash);
}
...
tfxU32 tfx__get_ribbon_slot(tfx_effect_manager pm) {
	...
	pm->ribbon_emitters.current_size++;
...
tfxU32 tfx__allocate_path_quaternion(tfx_effect_manager pm, tfxU32 amount) {
...
void tfx__free_path_quaternion(tfx_effect_manager pm, tfxU32 index) {
...
void tfx_SetPMCamera(tfx_effect_manager pm, float front[3], float position[3]) {
...
void tfx__reset_particle_effect_flags(tfx_effect_manager pm) {
	pm->flags = 0;
}

void tfx__free_compute_slot(tfx_effect_manager pm, unsigned int slot_id) {
	pm->free_compute_controllers.push_back(slot_id);
}

tfxU32 tfx_ParticleCount(tfx_effect_manager pm) {
	return pm->instance_buffer.current_size;
}

tfxU32 tfx_RibbonCount(tfx_effect_manager pm) {
	return pm->current_ribbon_count;
}

tfxU32 tfx_EffectCount(tfx_effect_manager pm) {
	tfxU32 count = 0;
	count += pm->effects_in_use[pm->current_ebuff].current_size;
	return count;
}

tfxU32 tfx_EmitterCount(tfx_effect_manager pm) {
	tfxU32 count = 0;
	count += pm->control_emitter_queue.current_size;
	return count;
}
...
tfxU32 tfx__grab_particle_lists(tfx_effect_manager pm, tfxKey emitter_hash, tfxU32 reserve_amount, tfxEmitterControlProfileFlags flags) {
	...
	tfx__init_particle_soa(&pm->particle_array_buffers[index], &pm->particle_arrays.back(), reserve_amount, flags);
	return index;
}
...
void tfx__free_ribbon(tfx_effect_manager pm, tfxKey bucket_hash, tfxU32 ribbon_index) {
	TFX_ASSERT(pm->ribbon_segment_buckets.ValidKey(bucket_hash));
	tfx_ribbon_bucket_t &bucket = pm->ribbon_segment_buckets.At(bucket_hash);
	bucket.free_ribbons.push_back(ribbon_index);
	bucket.active_ribbons--;
}

void tfx_FreeParticleListsMemory(tfx_effect_manager pm, tfx_effect_descriptor emitter) {
	if (pm->free_particle_lists.ValidKey(emitter->path_hash)) {
		...
		for (tfxU32 i : free_banks) {
			tfx__free_soa_buffer(&pm->particle_array_buffers[i]);
		}
		free_banks.free();
	}
	if (pm->free_particle_location_lists.ValidKey(emitter->path_hash)) {
		...
		for (tfxU32 i : free_banks) {
			tfx__free_soa_buffer(&pm->particle_location_buffers[i]);
		}
		free_banks.free();
	}
	for (tfx_effect_descriptor effect : emitter->children) {
		tfx_FreeEffectListsMemory(pm, effect);
	}
}

void tfx_FreeEffectListsMemory(tfx_effect_manager pm, tfx_effect_descriptor effect) {
	if (effect->type == tfxFolder) {
		for (tfx_effect_descriptor child : effect->children) {
			tfx_FreeEffectListsMemory(pm, child);
		}
	}
...
tfxU32 tfx__grab_particle_location_lists(tfx_effect_manager pm, tfxKey emitter_hash, tfxU32 reserve_amount) {
	...
	tfx__init_particle_location_soa(&pm->particle_location_buffers[index], &pm->particle_location_arrays.back(), reserve_amount);
	return index;
}
...
void tfx_DisablePMSpawning(tfx_effect_manager pm, bool yesno) {
	if (yesno) {
...
void tfx__update_effect(tfx_effect_manager pm, tfxU32 index, tfxU32 parent_index) {
	tfxPROFILE;
	...
	effect.oscillator_time = effect.age / 1000.f;
...
void tfx__update_ribbon_bucket_emitters(tfx_work_queue_t *work_queue, void *data) {
	...
	for (int ribbon_emitter_index : ribbon_work_entry->ribbon_bucket->ribbon_emitter_indexes[pm->current_ebuff]) {
		...
		float &timeout_counter = pm->ribbon_emitters[ribbon_emitter_index].timeout_counter;
		if (timeout_counter <= pm->ribbon_emitters[ribbon_emitter_index].timeout) {
			...
			tfx__sync_lock(&pm->add_effect_mutex);
			tfx__free_gpu_emitter(pm, pm->ribbon_emitters[ribbon_emitter_index].gpu_emitter_index);
...
void tfx__update_ribbon_emitter(tfxU32 ribbon_emitter_index, tfx_work_queue_t *work_queue, void *data) {
	...
	translation.x = tfx__sample_multi_node_graph(&library->graphs[ribbon_emitter.state_properties.transform_index].graphs[tfxTransform_translate_x_index], ribbon_emitter.age, ribbon_emitter.oscillator_time);
	translation.y = tfx__sample_multi_node_graph(&library->graphs[ribbon_emitter.state_properties.transform_index].graphs[tfxTransform_translate_y_index], ribbon_emitter.age, ribbon_emitter.oscillator_time);
	translation.z = tfx__sample_multi_node_graph(&library->graphs[ribbon_emitter.state_properties.transform_index].graphs[tfxTransform_translate_z_index], ribbon_emitter.age, ribbon_emitter.oscillator_time);

	ribbon_emitter.captured_position = ribbon_emitter.world_position;

	ribbon_emitter.oscillator_time = ribbon_emitter.age / 1000.f;

	local_rotations.roll = tfx__sample_multi_node_graph(&library->graphs[ribbon_emitter.state_properties.transform_index].graphs[tfxTransform_roll_index], ribbon_emitter.age, ribbon_emitter.oscillator_time);
	local_rotations.pitch = tfx__sample_multi_node_graph(&library->graphs[ribbon_emitter.state_properties.transform_index].graphs[tfxTransform_pitch_index], ribbon_emitter.age, ribbon_emitter.oscillator_time);
	local_rotations.yaw = tfx__sample_multi_node_graph(&library->graphs[ribbon_emitter.state_properties.transform_index].graphs[tfxTransform_yaw_index], ribbon_emitter.age, ribbon_emitter.oscillator_time);

	TFX_ASSERT(ribbon_emitter.parent_index != tfxINVALID);    //Emitter must have a valid parent (an effect)

	if (parent_effect.age < ribbon_emitter.state_properties.delay_spawning) {
		return;
	}

	parent_effect.timeout_counter = 0;
	ribbon_work_entry->effect_flags = pm->effects[ribbon_emitter.parent_index].effect_flags;
	bool ordered_effect = (ribbon_work_entry->effect_flags & tfxEffectPropertyFlags_age_order) || (ribbon_work_entry->effect_flags & tfxEffectPropertyFlags_depth_draw_order) > 0;
	...
	ribbon_work_entry->parent_spawn_controls = &parent_effect.spawn_controls;
	ribbon_work_entry->parent_index = ribbon_emitter.parent_index;
	...
	tfx__transform_3d(&ribbon_emitter.world_rotations, &local_rotations, &ribbon_work_entry->overal_scale, &ribbon_emitter.world_position, &ribbon_emitter.local_position, &translation, &ribbon_emitter.rotation, &parent_effect);
	...
	float tween = 0;
	if (step_size == ribbon_emitter.qty_step_size || ribbon_emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_single) {
		tween = ribbon_emitter.amount_remainder;
	} else {
		tween = ribbon_emitter.amount_remainder - (ribbon_emitter.qty_step_size - step_size);
	}
	ribbon_emitter.qty_step_size = step_size;

	if (tween >= 1) {
		tween -= ribbon_emitter.spawn_quantity;
	}

	ribbon_work_entry->tween = tween;
	ribbon_work_entry->qty_step_size = step_size;
	ribbon_work_entry->amount_to_spawn = 0;

	if (tween >= 1) {
		ribbon_emitter.amount_remainder = tween - 1.f;
	} else if (!(ribbon_emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_single)) {
		float amount_that_will_spawn = (1.f - tween) / step_size;
		ribbon_work_entry->amount_to_spawn = (tfxU32)ceilf(amount_that_will_spawn);
		if (ribbon_work_entry->amount_to_spawn > ribbon_work_entry->new_ribbons) {
			ribbon_work_entry->amount_to_spawn = ribbon_work_entry->new_ribbons;
			ribbon_emitter.amount_remainder = 0.f;
		} else {
			ribbon_emitter.amount_remainder = amount_that_will_spawn - (tfxU32)amount_that_will_spawn;
			ribbon_emitter.amount_remainder = (1.f - ribbon_emitter.amount_remainder) * step_size;
		}
	} else {
	...
	if (ribbon_emitter.source_ribbon->state_properties.loop_length && ribbon_emitter.age > ribbon_emitter.source_ribbon->state_properties.loop_length) {
...
void tfx__update_bucket(tfx_work_queue_t *work_queue, void *data) {
	tfxPROFILE;
	tfx_spawn_work_entry_t *spawn_work_entry = static_cast<tfx_spawn_work_entry_t *>(data);
	tfx_effect_manager pm = spawn_work_entry->pm;
	tfx_emitter_bucket bucket = spawn_work_entry->bucket;
	tfx_shared_properties_t *shared_properties = &bucket->library->shared_properties[bucket->state_properties.shared_index];
	bool emitters_are_alive = false;
	tfxU32 total_spawn_count = 0;
	for (tfx_particle_emitter_state_t &emitter : bucket->emitter_states) {
		tfx_effect_state_t *parent_effect = &pm->effects[emitter.parent_index];
		tfx__update_emitter(work_queue, spawn_work_entry, parent_effect);
		tfxU32 emitter_spawn_count = tfx__new_sprites_needed(pm, &spawn_work_entry->random, &emitter, parent_effect, shared_properties);
		tfx__prepare_emitter_spawns(&emitter, &emitter_spawn_count, bucket, pm);

		emitter.pending_spawn_count = emitter_spawn_count;
		total_spawn_count += emitter_spawn_count;

		float &timeout_counter = emitter.timeout_counter;

		if (timeout_counter <= emitter.timeout) {
			bucket->emitter_states[spawn_work_entry->next_buffer].push_back(emitter);
			emitters_are_alive = true;
		} else {
			tfx__sync_lock(&pm->add_effect_mutex);
	...
	tfx_vector_t<tfx_unique_sprite_id_t> &uid_buffer = pm->unique_sprite_ids[pm->current_sprite_buffer][shared_properties->layer];
	bool is_recording = (pm->flags & tfxEffectManagerFlags_recording_sprites) > 0 && (pm->flags & tfxEffectManagerFlags_using_uids) > 0;
	tfx_buffer_t &instance_buffer = !is_recording ? pm->instance_buffer : pm->instance_buffer_for_recording[pm->current_sprite_buffer][shared_properties->layer];

	bucket->sprites_count = pm->particle_array_buffers[bucket->particles_index].current_size;
	if (pm->flags & tfxEffectManagerFlags_dynamic_sprite_allocation) {
		if (bucket->sprites_count + instance_buffer.current_size + total_spawn_count >= instance_buffer.capacity) {
			tfxU32 new_size = instance_buffer.capacity + (bucket->sprites_count + total_spawn_count) + 1;
		...
		tfxU32 required_space = bucket->sprites_count + instance_buffer.current_size + total_spawn_count;
		if (required_space >= instance_buffer.capacity) {
			tfxU32 free_space = instance_buffer.capacity - instance_buffer.current_size;
			if (free_space > bucket->sprites_count) {
				total_spawn_count = free_space - bucket->sprites_count;
			}
			else {
				total_spawn_count = tfxMin(free_space, total_spawn_count);
			}
			TFX_ASSERT(free_space >= total_spawn_count);    //Trying to spawn particles when no space left in sprite buffer. If this is hit then there's a bug in TimelineFX!
		}
	}

	instance_buffer.current_size += total_spawn_count + bucket->sprites_count;
	bucket->sprites_count += total_spawn_count;

	spawn_work_entry->total_spawn_count = total_spawn_count;

	bucket->emitter_states[pm->current_ebuff].clear();

	if (!(pm->flags & tfxEffectManagerFlags_disable_spawning)) {
		tfx__spawn_particles(spawn_work_entry);
	}

	tfxU32 spawn_difference = total_spawn_count - work_entry->actual_spawned;
	instance_buffer.current_size -= spawn_difference;
	TFX_ASSERT(instance_buffer.current_size < instance_buffer.capacity);
	bucket->sprites_count -= spawn_difference;
	pm->layer_sizes[shared_properties->layer] += bucket->sprites_count;

	if (pm->flags & tfxEffectManagerFlags_recording_sprites && pm->flags & tfxEffectManagerFlags_using_uids) {
		uid_buffer.current_size = instance_buffer.current_size;
	}

	if (emitters_are_alive) {
		pm->control_emitter_queue.push_back(bucket);
	}
}

void tfx__prepare_emitter_spawns(tfx_particle_emitter_state_t *emitter, tfxU32 *emitter_spawn_count, tfx_emitter_bucket bucket, tfx_effect_manager pm) {
	const tfx_emission_type emission_type = bucket->library->shared_properties[bucket->state_properties.shared_index].emission_type;
	...
	float tween = 0;
	if (step_size == emitter->qty_step_size || bucket->state_properties.shared_flags & tfxSharedEmitterPropertyFlags_single) {
	...
	tfxU32 max_spawn_count = *emitter_spawn_count;
	emitter->tween = tween;

	if (tween >= 1) {
		emitter->amount_remainder = tween - 1.f;
	}
	else if (!(bucket->state_properties.shared_flags & tfxSharedEmitterPropertyFlags_single)) {
		float amount_that_will_spawn = (1.f - tween) / step_size;
		*emitter_spawn_count = (tfxU32)ceilf(amount_that_will_spawn);
		if (*emitter_spawn_count > max_spawn_count) {
			*emitter_spawn_count = max_spawn_count;
			emitter->amount_remainder = 0.f;
		}
		else {
		...
		*emitter_spawn_count = (tfxU32)emitter->spawn_quantity;
	}

	if (emission_type == tfxOtherEmitter) {
	...
	} else if (emission_type == tfxSpawnOnRibbon) {
	...
	if ((bucket->state_properties.property_flags & tfxEmitterPropertyFlags_run_on_gpu) && *emitter_spawn_count > 0) {
		*emitter_spawn_count -= tfx__gpu_group_record_spawns(pm, bucket->state_properties.gpu_group_index, *emitter_spawn_count, pm->gpu_current_time_ms);
	}

	if (*emitter_spawn_count > 0 && bucket->state_properties.shared_flags & tfxSharedEmitterPropertyFlags_single && emission_type != tfxOtherEmitter) {
		emitter->state_flags |= tfxEmitterStateFlags_single_shot_done;
	}
}

void tfx__update_emitter(tfx_particle_emitter_state_t *emitter, tfx_spawn_work_entry_t *work_entry, tfx_effect_state_t *parent_effect) {
	tfxPROFILE;
	tfx_effect_manager pm = work_entry->pm;
	...
	tfx_graph_t &translation_x_graph = library->graphs[emitter->state_properties.transform_index].graphs[tfxTransform_translate_x_index];
	tfx_graph_t &translation_y_graph = library->graphs[emitter->state_properties.transform_index].graphs[tfxTransform_translate_y_index];
	tfx_graph_t &translation_z_graph = library->graphs[emitter->state_properties.transform_index].graphs[tfxTransform_translate_z_index];
	tfx_graph_t &roll_graph = library->graphs[emitter->state_properties.transform_index].graphs[tfxTransform_roll_index];
	tfx_graph_t &pitch_graph = library->graphs[emitter->state_properties.transform_index].graphs[tfxTransform_pitch_index];
	tfx_graph_t &yaw_graph = library->graphs[emitter->state_properties.transform_index].graphs[tfxTransform_yaw_index];

	translation.x = tfx__sample_multi_node_graph(&translation_x_graph, emitter->age, emitter->oscillator_time);
	translation.y = tfx__sample_multi_node_graph(&translation_y_graph, emitter->age, emitter->oscillator_time);
	translation.z = tfx__sample_multi_node_graph(&translation_z_graph, emitter->age, emitter->oscillator_time);

	emitter->captured_position = emitter->world_position;
	emitter->captured_rotation = emitter->rotation;

	emitter->oscillator_time = emitter->age / 1000.f;

	local_rotations.roll = tfx__sample_multi_node_graph(&roll_graph, emitter->age, emitter->oscillator_time);
	...
	float t = emitter->state_properties.loop_length > 0.f ? emitter->age / emitter->state_properties.loop_length : 0.f;

	work_entry->highest_particle_age = emitter->highest_particle_age;

	tfx_shared_properties_t &shared_properties = *work_entry->shared_properties;
	...
	work_entry->root_effect_flags = pm->effects[emitter->parent_index].effect_flags;
	...
	work_entry->parent_spawn_controls = &parent_effect->spawn_controls;
	work_entry->parent_property_flags = parent_effect->property_flags;
	work_entry->parent_index = emitter->parent_index;
	work_entry->overal_scale = parent_effect->overal_scale;
	tfx__update_emitter_state(pm, emitter, emitter->parent_index, work_entry->parent_spawn_controls, work_entry);
	tfx__transform_3d(&emitter->world_rotations, &local_rotations, &work_entry->overal_scale, &emitter->world_position, &emitter->local_position, &translation, &emitter->rotation, &parent_effect->arent_effect);
	...
	if (!(emitter->state_properties.shared_flags & tfxSharedEmitterPropertyFlags_single) || (emitter->state_properties.shared_flags & tfxSharedEmitterPropertyFlags_single && shared_properties.single_shot_limit > 0) || emitter->state_flags & tfxEmitterStateFlags_stop_spawning) {
		emitter->highest_particle_age -= pm->frame_length;
		work_entry->highest_particle_age -= pm->frame_length;
	}
...
tfxU32 tfx__new_sprites_needed(tfx_effect_manager pm, tfx_random_t *random, tfx_particle_emitter_state_t *emitter, tfx_effect_state_t *parent, tfx_shared_properties_t *shared_properties) {
	tfx_library library = emitter->library;
	...
	if (shared_properties->emission_type == tfxPath && emitter->state_flags & tfxEmitterStateFlags_has_rotated_path) {
		tfx_emitter->state_properties.path_attributes];
	...
	if (emitter->spawn_locations_index != tfxINVALID && shared_properties->emission_type == tfxOtherEmitter && emitter->state_properties.property_flags & tfxEmitterPropertyFlags_use_spawn_ratio) {
		tfx_soa_buffer_t &spawn_point_buffer = pm->particle_location_buffers[emitter->spawn_locations_index];
		emitter->spawn_quantity *= spawn_point_buffer.current_size;
	} else if (shared_properties->emission_type == tfxSpawnOnRibbon && emitter->state_properties.property_flags & tfxEmitterPropertyFlags_use_spawn_ratio) {
		if (emitter->other_emitter->mitter_index != tfxINVALID) {
			emitter->spawn_quantity *= pm->ribbon_emitter->other_emitter->ribbon_indexes[pm->current_ebuff].current_size;
		} else {
			return 0;
		}
	}
	...
	if (!(emitter->state_properties.shared_flags & tfxSharedEmitterPropertyFlags_single)) {
		if (emitter->state_properties.property_flags & tfxEmitterPropertyFlags_use_spawn_ratio && (shared_properties->emission_type == tfxArea || shared_properties->emission_type == tfxEllipse)) {
			float area = tfxMax(0.1f, emitter->emitter->x) * tfxMax(0.1f, emitter->emitter->y) * tfxMax(0.1f, emitter->emitter->z);
			...
			emitter->spawn_quantity = (emitter->spawn_quantity / 100.f) * emitter->emitter->y;
		}
...
tfxU32 tfx__new_ribbons_needed(tfx_effect_manager pm, tfx_random_t *random, tfxU32 index, tfx_effect_state_t *parent, tfx_shared_properties_t *shared_properties) {
	tfx_ribbon_emitter_state_t &ribbon_emitter = pm->ribbon_emitters[index];
	tfx_library library = ribbon_emitter.library;
	tfx_AlterRandomSeedU32(random, 25 + ribbon_emitter.seed_index);
	if (!(ribbon_emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_single)) {
		ribbon_emitter.spawn_quantity = tfx__sample_multi_node_graph(&library->graphs[ribbon_emitter.state_properties.graph_list_index].graphs[tfxRibbon_base_amount_index], ribbon_emitter.age, ribbon_emitter.oscillator_time);
		float amount_variation = tfx__sample_multi_node_graph(&library->graphs[ribbon_emitter.state_properties.graph_list_index].graphs[tfxRibbon_variation_amount_index], ribbon_emitter.age, ribbon_emitter.oscillator_time);
		ribbon_emitter.spawn_quantity += amount_variation > 0.f ? tfx_RandomRangeFromTo(random, 1.f, amount_variation) : 0.f;
	} else {
...
void tfx_CompleteEffectManagerWork(tfx_effect_manager pm) {
	tfx__complete_all_work(&pm->work_queue);
}

void tfx__spawn_particles(tfx_spawn_work_entry_t *work_entry) {
	tfx_effect_manager pm = work_entry->pm;
	tfx_emitter_bucket bucket = work_entry->bucket;

	tfx_soa_buffer_t &buffer = pm->particle_array_buffers[bucket->particles_index];

	bool grew = false;
	tfxU32 start_index = buffer.start_index;
	work_entry->spawn_start_index = tfx__add_soa_rows_grew(&pm->particle_array_buffers[bucket->particles_index], work_entry->total_spawn_count, true, grew);
	tfx_shared_properties_t *shared_properties = &bucket->library->shared_properties[bucket->state_properties.shared_index];
	work_entry->emission_type = shared_properties->emission_type;
	work_entry->particle_data = &pm->particle_arrays[bucket->particles_index];
	...
	for (tfx_particle_emitter_state_t &emitter : bucket->emitter_states) {
		if ((work_entry->emission_type == tfxSpawnOnRibbon && emitter.other_emitter_index == tfxINVALID)
			...
			emitter.pending_spawn_count = 0;
			continue;
		}
		work_entry->amount_to_spawn = emitter.pending_spawn_count;
		work_entry->actual_spawned += emitter.pending_spawn_count;
		tfx__spawn_particle_age(work_entry);
		if (work_entry->emission_type == tfxOtherEmitter) {
			if (emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_single) {
				tfx__spawn_particle_other_emitter_single(work_entry);
			} else {
				tfx__spawn_particle_other_emitter(work_entry);
			}
		} else if (work_entry->emission_type == tfxSpawnOnRibbon) {
			tfx__spawn_particle_other_ribbon_emitter(work_entry);
		} else if (work_entry->emission_type == tfxPoint) {
			tfx__spawn_particle_point(work_entry);
		} else if (work_entry->emission_type == tfxArea) {
			tfx__spawn_particle_area(work_entry);
		} else if (work_entry->emission_type == tfxEllipse) {
			tfx__spawn_particle_ellipsoid(work_entry);
		} else if (work_entry->emission_type == tfxLine && !(bucket->state_properties.property_flags & tfxEmitterPropertyFlags_use_path_as_trajectory)) {
			tfx__spawn_particle_line(work_entry);
		} else if (work_entry->emission_type == tfxLine && (bucket->state_properties.property_flags & tfxEmitterPropertyFlags_use_path_as_trajectory)) {
			tfx__spawn_particle_line_start(work_entry);
		} else if (work_entry->emission_type == tfxIcosphere && bucket->state_properties.shared_flags & tfxSharedEmitterPropertyFlags_grid_spawn_random) {
			tfx__spawn_particle_icosphere_random(work_entry);
		} else if (work_entry->emission_type == tfxIcosphere && !(bucket->state_properties.shared_flags & tfxSharedEmitterPropertyFlags_grid_spawn_random)) {
			tfx__spawn_particle_icosphere(work_entry);
		} else if (work_entry->emission_type == tfxCylinder) {
			tfx__spawn_particle_cylinder(work_entry);
		} else if (work_entry->emission_type == tfxPath && !(bucket->state_properties.property_flags & tfxEmitterPropertyFlags_use_path_as_trajectory)) {
			tfx__spawn_particle_path(work_entry);
		} else if (work_entry->emission_type == tfxPath && (bucket->state_properties.property_flags & tfxEmitterPropertyFlags_use_path_as_trajectory)) {
			tfx__spawn_particle_path_start(work_entry);
		}

		if ((work_entry->emission_type == tfxPath || work_entry->emission_type == tfxLine) && !(bucket->state_properties.property_flags & tfxEmitterPropertyFlags_use_path_as_trajectory)) {
			tfx__spawn_particle_velocity(work_entry);
		} else if (work_entry->emission_type != tfxPath && work_entry->emission_type != tfxLine) {
			tfx__spawn_particle_velocity(work_entry);
		}

		tfx__spawn_particle_weight(work_entry);
		tfx__spawn_particle_micro_update(work_entry);
		if (bucket->state_properties.control_profile & tfxEmitterControlProfile_has_simplex_noise_type) {
			tfx__spawn_particle_noise(work_entry);
		} else if (bucket->state_properties.control_profile & tfxEmitterControlProfile_motion_randomness) {
			tfx__spawn_particle_motion_randomness(work_entry);
		}
		tfx__spawn_particle_image_frame(work_entry);
		tfx__spawn_particle_size(work_entry);
		tfx__spawn_particle_spin(work_entry);

		work_entry->spawn_start_index += work_entry->amount_to_spawn;
	}
}

void tfx__spawn_particle_age(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	...
	const tfxU32 loop_count = entry->shared_properties->single_shot_limit + 1;
	const float emitter_intensity = entry->parent_spawn_controls->intensity;
	const float first_red_value = tfx__get_graph_first_value(&library->graphs[emitter.state_properties.graph_list_index].graphs[tfxEmitter_overtime_red_index]);
	const float first_green_value = tfx__get_graph_first_value(&library->graphs[emitter.state_properties.graph_list_index].graphs[tfxEmitter_overtime_green_index]);
	const float first_blue_value = tfx__get_graph_first_value(&library->graphs[emitter.state_properties.graph_list_index].graphs[tfxEmitter_overtime_blue_index]);
	const float first_alpha_value = tfx__get_graph_first_value(&library->graphs[emitter.state_properties.graph_list_index].graphs[tfxEmitter_overtime_blendfactor_index]);
	const tfx_color_ramp_t &color_ramp = library->graphs[emitter.state_properties.graph_list_index].color_ramps;
	...
	bool factor_intensity_is_bezier_graph = tfx__graph_has_bezier_curves(factor_intensity_graph);
	bool factor_intensity_has_oscillator = tfx__graph_can_oscillate(factor_intensity_graph);
	...
	for (int i = 0; i != entry->amount_to_spawn; ++i) {
		...
		if ((entry->emission_type == tfxOtherEmitter && emitter.other_emitter_index == tfxINVALID) || (entry->emission_type == tfxSpawnOnRibbon)) {
			...
			if ((entry->emission_type == tfxOtherEmitter && emitter.other_emitter_index == tfxINVALID)) {
				...
				time = pm.particle_location_arrays[emitter.spawn_locations_index].age[spawn_index];
			} else {
				...
				time = ribbon_bucket.ribbons.ribbon_instances[ribbon_emitter.ribbon_indexes[pm.current_ebuff][spawn_index]].position.w;
				emitter.grid_coords.x++;
			}

			float factor_life_time = factor_life_easing(time);
			float factor_life = factor_life_is_bezier_graph ?
				tfx__bezier_sampler(factor_life_time, factor_life_graph->nodes[0].value, factor_life_graph->nodes[0].right.y, factor_life_graph->nodes[1].left.y, factor_life_graph->nodes[1].value) :
				tfx__linear_sampler(factor_life_graph->nodes[0].value, factor_life_graph->nodes[1].value, factor_life_time);

			float factor_intensity_time = factor_intensity_easing(time);
			float factor_intensity = factor_intensity_is_bezier_graph ?
				tfx__bezier_sampler(factor_intensity_time, factor_intensity_graph->nodes[0].value, factor_intensity_graph->nodes[0].right.y, factor_intensity_graph->nodes[1].left.y, factor_intensity_graph->nodes[1].value) :
				tfx__linear_sampler(factor_intensity_graph->nodes[0].value, factor_intensity_graph->nodes[1].value, factor_intensity_time);

			if (factor_life_has_oscillator) {
				factor_life *= (tfxOSCILLATOR_SIN(factor_life_graph->oscillator.offset_x + factor_life_time, factor_life_graph->oscillator.frequency, factor_life_graph->oscillator.amplitude) + factor_life_graph->oscillator.offset_y);
			}

			if (factor_intensity_has_oscillator) {
				factor_intensity *= (tfxOSCILLATOR_SIN(factor_intensity_graph->oscillator.offset_x + factor_intensity_time, factor_intensity_graph->oscillator.frequency, factor_intensity_graph->oscillator.amplitude) + factor_intensity_graph->oscillator.offset_y);
			}

			max_age *= factor_life;
			max_age = tfx__Max(max_age, pm.frame_length);
			entry->particle_data->intensity_factor[index] = factor_intensity;
		} else {
...
void tfx__spawn_particle_image_frame(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	...
	for (int i = 0; i != entry->amount_to_spawn; ++i) {
		...
		if (emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_random_start_frame && emitter.state_properties.image->animation_frames > 1) {
			...
			image_frame = shared_properties.start_frame;
		}
...
void tfx__spawn_particle_size(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	...
	tfx_vec2_t &image_size = emitter.state_properties.image->image_size;
	...
	for (int i = 0; i != entry->amount_to_spawn; ++i) {
		...
		tfxU32 index = tfx__get_circular_index(&pm.particle_array_buffers[emitter.particles_index], entry->spawn_start_index + i);
#ifdef tfxHALFFLOATS	
		float base_size_x = 0.f;
		float base_size_y = 0.f;
#else
		...
		if (entry->emission_type == tfxOtherEmitter) {
			int spawn_index = (int)emitter.grid_coords.x;
			spawn_index = tfx__get_circular_index(&pm.particle_location_buffers[emitter.spawn_locations_index], spawn_index);
			float time = pm.particle_location_arrays[emitter.spawn_locations_index].age[spawn_index];
		...
		if (entry->emission_type == tfxSpawnOnRibbon) {
			...
			tfx_ribbon_bucket_t &ribbon_bucket = pm.ribbon_segment_buckets.At(ribbon_emitter.ribbon_bucket_id);
			int spawn_index = (int)emitter.grid_coords.x % ribbon_emitter.ribbon_indexes[pm.current_ebuff].current_size;
			float time = ribbon_bucket.ribbons.ribbon_instances[ribbon_emitter.ribbon_indexes[pm.current_ebuff][spawn_index]].position.w;
...
#ifdef tfxHALFFLOATS
		entry->particle_data->base_size_x[index] = tfx__float_to_half(base_size_x);
		entry->particle_data->base_size_y[index] = tfx__float_to_half(base_size_y);
#endif
	}
}

void tfx__spawn_particle_noise(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	...
	for (int i = 0; i != entry->amount_to_spawn; ++i) {
		...
		tfxU32 index = tfx__get_circular_index(&pm.particle_array_buffers[emitter.particles_index], entry->spawn_start_index + i);
#ifdef tfxHALFFLOATS
		float noise_offset = noise_offset = tfx_RandomRangeZeroToMax(&random, emitter_noise_offset_variation) + emitter_noise_offset + parent_noise_base_offset;
		float noise_resolution = emitter_noise_resolution + 0.01f;
		entry->particle_data->noise_offset[index] = tfx__float_to_half(noise_offset);
		entry->particle_data->noise_resolution[index] = tfx__float_to_half(noise_resolution);
#else
...
void tfx__spawn_particle_motion_randomness(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
...
void tfx__spawn_particle_spin(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	...
	for (int i = 0; i != entry->amount_to_spawn; ++i) {
...
#ifdef tfxHALFFLOATS
		float base_roll_spin = tfx_RandomRangeFromTo(&random, -spin_variation, spin_variation) + roll_spin;
		entry->particle_data->base_roll_spin[index] = tfx__float_to_half(base_roll_spin);
		if (emitter.state_flags & tfxEmitterStateFlags_can_spin_pitch_and_yaw) {
			 float base_pitch_spin = tfx_RandomRangeFromTo(&random, -spin_pitch_variation, spin_pitch_variation) + pitch_spin;
			 float base_yaw_spin = tfx_RandomRangeFromTo(&random, -spin_yaw_variation, spin_yaw_variation) + yaw_spin;
			entry->particle_data->base_pitch_spin[index] = tfx__float_to_half(base_pitch_spin);
			entry->particle_data->base_yaw_spin[index] = tfx__float_to_half(base_yaw_spin);
		}
#else
		float &base_roll_spin = entry->particle_data->base_roll_spin[index];
		base_roll_spin = tfx_RandomRangeFromTo(&random, -spin_variation, spin_variation) + roll_spin;
		if (emitter.state_flags & tfxEmitterStateFlags_can_spin_pitch_and_yaw) {
		...
		if (emitter.state_flags & tfxEmitterStateFlags_can_spin_pitch_and_yaw) {
			tfxU32 &rotation_offsets = entry->particle_data->rotation_offsets[index];
			tfx_vec3_t offsets;
			const float rPI = 1.f / tfxPI2;
			if (angle_settings & tfxAngleSettingFlags_specify_pitch) {
				offsets.pitch = emitter.state_properties.angle_offsets.pitch;
			} else {
				offsets.pitch = tfx_RandomRangeZeroToMax(&random, emitter.state_properties.angle_offsets.pitch);
			}
			if (angle_settings & tfxAngleSettingFlags_specify_yaw) { 
				offsets.yaw = emitter.state_properties.angle_offsets.yaw; 
			} else {
				offsets.yaw = tfx_RandomRangeZeroToMax(&random, emitter.state_properties.angle_offsets.yaw);
			}
			if (angle_settings & tfxAngleSettingFlags_specify_roll) {
				offsets.roll = emitter.state_properties.angle_offsets.roll;
			} else { 
				offsets.roll = tfx_RandomRangeZeroToMax(&random, emitter.state_properties.angle_offsets.roll); 
			}
			offsets *= rPI;
			rotation_offsets = tfx__pack10bit_unsigned(&offsets);
		} else {
			float &rotation_offset = entry->particle_data->rotation_offset[index];
			if (angle_settings & tfxAngleSettingFlags_specify_roll) {
				rotation_offset = emitter.state_properties.angle_offsets.roll;
			} else {
				rotation_offset = tfx_RandomRangeZeroToMax(&random, emitter.state_properties.angle_offsets.roll);
			}
		}
...
void tfx__spawn_particle_point(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	tfx_spawn_work_entry_t *entry = static_cast<tfx_spawn_work_entry_t *>(data);
	tfx_random_t random = entry->random;
	float tween = 0.f;
...
void tfx__spawn_particle_other_ribbon_emitter(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	tfx_spawn_work_entry_t *entry = static_cast<tfx_spawn_work_entry_t *>(data);
	tfx_random_t random = entry->random;
	float tween = 0.f;
	...
	for (int i = 0; i != entry->amount_to_spawn; ++i) {
		...
		if (emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_spawn_on_grid) {
...
void tfx__spawn_particle_other_emitter(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	tfx_spawn_work_entry_t *entry = static_cast<tfx_spawn_work_entry_t *>(data);
	tfx_random_t random = entry->random;
	float tween = 0.f;
...
void tfx__spawn_particle_other_emitter_single(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	tfx_spawn_work_entry_t *entry = static_cast<tfx_spawn_work_entry_t *>(data);
	tfx_random_t random = entry->random;
	float tween = 0.f;
	...
	tfxU32 amount_to_spawn = entry->amount_to_spawn / spawn_point_buffer.current_size;
	...
	for (int s = 0; s != spawn_point_buffer.current_size; ++s) {
		...
		for (int i = 0; i != amount_to_spawn; ++i) {
			...
			if (!(emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_relative_position) && !(emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_emitter_handle_auto_center)) {
				tfx_vec3_t rotvec = tfx__rotate_vector_quaternion(&emitter.rotation, emitter.handle);
				local_position_x = rotvec.x + local_position_x;
				local_position_y = rotvec.y + local_position_y;
				local_position_z = rotvec.z + local_position_z;
			}
			spawned++;
		}
	}
...
void tfx__spawn_particle_line(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	tfx_spawn_work_entry_t *entry = static_cast<tfx_spawn_work_entry_t *>(data);
	tfx_random_t random = entry->random;
	float tween = entry->tween;
...
void tfx__spawn_particle_line_start(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	tfx_spawn_work_entry_t *entry = static_cast<tfx_spawn_work_entry_t *>(data);
	tfx_random_t random = entry->random;
	float tween = entry->tween;
	...
	for (int i = 0; i != entry->amount_to_spawn; ++i) {
		...
		float &local_position_z = entry->particle_data->position_z[index];
#ifdef tfxHALFFLOATS
		entry->particle_data->path_scale_variation[index] = tfx__float_to_half(1.f + tfx_RandomRangeZeroToMax(&random, path_scale_variation));
#else
		entry->particle_data->path_scale_variation[index] = 1.f + tfx_RandomRangeZeroToMax(&random, path_scale_variation);
#endif
...
void tfx__spawn_particle_area(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	tfx_spawn_work_entry_t *entry = static_cast<tfx_spawn_work_entry_t *>(data);
	tfx_random_t random = entry->random;
	float tween = entry->tween;
		...
		if (emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_spawn_on_grid) {
			...
			if (emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_fill_area) {
				...
				if (emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_grid_spawn_random) {
					...
					tfxU32 side = tfx_RandomRangeZeroToMaxUInt(&random, (emitter.state_properties.property_flags & tfxEmitterPropertyFlags_area_open_ends) ? (tfxU32)4 : (tfxU32)6);
					...
					tfx_vec3_t velocity_normal;
					if (!(emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_grid_spawn_clockwise)) {
						if ((emitter.grid_coords.z > 0 && emitter.grid_coords.z < grid_points.z - 1) || emitter.state_properties.property_flags & tfxEmitterPropertyFlags_area_open_ends) {
...
void tfx__spawn_particle_ellipsoid(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	tfx_spawn_work_entry_t *entry = static_cast<tfx_spawn_work_entry_t *>(data);
	tfx_random_t random = entry->random;
	float tween = entry->tween;
...
void tfx__spawn_particle_icosphere(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	tfx_spawn_work_entry_t *entry = static_cast<tfx_spawn_work_entry_t *>(data);
	tfx_random_t random = entry->random;
	float tween = entry->tween;
	...
	tfx_vec3_t half_emitter_size = emitter.emitter_size * .5f;
	tfxU32 sub_division = tfx__Min((tfxU32)entry->shared_properties->grid_points.x, 5);
...
void tfx__spawn_particle_path_start(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	tfx_spawn_work_entry_t *entry = static_cast<tfx_spawn_work_entry_t *>(data);
	tfx_random_t random = entry->random;
	float tween = entry->tween;
	...
	for (int i = 0; i != entry->amount_to_spawn; ++i) {
		...
		tfx__catmull_rom_spline_3d_soa(path->buffers.node_soa.x, path->buffers.node_soa.y, path->buffers.node_soa.z, 0, 0.f, &point.x);
...
void tfx__spawn_particle_path(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	tfx_spawn_work_entry_t *entry = static_cast<tfx_spawn_work_entry_t *>(data);
	tfx_random_t random = entry->random;
	float tween = entry->tween;
...
void tfx__spawn_static_ribbons(tfx_spawn_work_entry_t *entry) {
	...
	tfx_emitter_path_t *path = &library->paths[ribbon_emitter.state_properties.path_attributes];
	tfx_graph_list_t &graph_list = library->graphs[ribbon_emitter.state_properties.graph_list_index];
	...
	float arc_size = tfx__sample_multi_node_graph(&library->graphs[ribbon_emitter.state_properties.graph_list_index].graphs[tfxRibbon_property_arc_size_index], ribbon_emitter.age, ribbon_emitter.oscillator_time);
	float arc_offset = tfx__sample_multi_node_graph(&library->graphs[ribbon_emitter.state_properties.graph_list_index].graphs[tfxRibbon_property_arc_offset_index], ribbon_emitter.age, ribbon_emitter.oscillator_time);
	float extrusion = tfx__sample_multi_node_graph(&library->graphs[ribbon_emitter.state_properties.graph_list_index].graphs[tfxRibbon_property_extrusion_index], ribbon_emitter.age, ribbon_emitter.oscillator_time);
	...
	if (ribbon_emitter.static_segment_start_index != tfxINVALID) {
		...
		const float splatter = tfx__sample_multi_node_graph(&library->graphs[ribbon_emitter.state_properties.graph_list_index].graphs[tfxRibbon_property_splatter_index], ribbon_emitter.age, ribbon_emitter.oscillator_time) * entry->parent_spawn_controls->splatter;
		for (int i = 0; i != entry->amount_to_spawn; ++i) {
...
void tfx__spawn_particle_icosphere_random(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	tfx_spawn_work_entry_t *entry = static_cast<tfx_spawn_work_entry_t *>(data);
	tfx_random_t random = entry->random;
	float tween = entry->tween;
...
void tfx__spawn_particle_cylinder(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	tfx_spawn_work_entry_t *entry = static_cast<tfx_spawn_work_entry_t *>(data);
	tfx_random_t random = entry->random;
	float tween = entry->tween;
	...
	for (int i = 0; i != entry->amount_to_spawn; ++i) {
		...
		if (emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_spawn_on_grid && !(emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_fill_area)) {
			if (emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_grid_spawn_random) {
				emitter.grid_coords.x = (float)tfx_RandomRangeZeroToMaxUInt(&random, (tfxU32)grid_points.x);
				emitter.grid_coords.y = (float)tfx_RandomRangeZeroToMaxUInt(&random, (tfxU32)grid_points.y);
		...
		else if (!(emitter.state_properties.shared_flags & tfxSharedEmitterPropertyFlags_fill_area)) {
...
void tfx__spawn_particle_weight(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	tfx_spawn_work_entry_t *entry = static_cast<tfx_spawn_work_entry_t *>(data);
	tfx_random_t random = entry->random;
	tfx_effect_manager_t &pm = *entry->pm;
...
#ifdef tfxHALFFLOATS
		entry->particle_data->base_weight[index] = tfx__float_to_half(base_weight);
#endif
	}

}

void tfx__spawn_particle_velocity(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	tfx_spawn_work_entry_t *entry = static_cast<tfx_spawn_work_entry_t *>(data);
	tfx_random_t random = entry->random;
	tfx_effect_manager_t &pm = *entry->pm;
	...
	for (int i = 0; i != entry->amount_to_spawn; ++i) {
		...
		if (entry->emission_type == tfxOtherEmitter) {
			...
			float velocity_time = velocity_easing(time);
			float velocity_factor = velocity_is_bezier_graph ?
				tfx__bezier_sampler(velocity_time, velocity_graph->nodes[0].value, velocity_graph->nodes[0].right.y, velocity_graph->nodes[1].left.y, velocity_graph->nodes[1].value) :
				tfx__linear_sampler(velocity_graph->nodes[0].value, velocity_graph->nodes[1].value, velocity_time);

			if (velocity_has_oscillator) {
				velocity_factor *= (tfxOSCILLATOR_SIN(velocity_graph->oscillator.offset_x + velocity_time, velocity_graph->oscillator.frequency, velocity_graph->oscillator.amplitude) + velocity_graph->oscillator.offset_y);
			}
...
#ifdef tfxHALFFLOATS
		entry->particle_data->base_velocity[index] = tfx__float_to_half(base_velocity);
#endif
...
void tfx__spawn_particle_micro_update(tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;
	tfx_spawn_work_entry_t *entry = static_cast<tfx_spawn_work_entry_t *>(data);
	tfx_random_t random = entry->random;
	tfx_effect_manager_t &pm = *entry->pm;
	...
	tfx_graph_list_t *ribbon_graph_list = ribbon_emitter ? &library->graphs[ribbon_emitter->state_properties.graph_list_index] : nullptr;
	...
	if (splatter || entry->emission_type == tfxSpawnOnRibbon) {
		for (int i = 0; i != entry->amount_to_spawn; ++i) {
			...
			if (entry->emission_type == tfxSpawnOnRibbon) {
				...
				float width_overlength_time = width_overlength_easing(ribbon_lerp);
				factor = width_overlength_is_bezier_graph ?
					tfx__bezier_sampler(width_overlength_time, width_overlength_graph->nodes[0].value, width_overlength_graph->nodes[0].right.y, width_overlength_graph->nodes[1].left.y, width_overlength_graph->nodes[1].value) :
					tfx__linear_sampler(width_overlength_graph->nodes[0].value, width_overlength_graph->nodes[1].value, width_overlength_time);

				if (width_overlength_has_oscillator) {
					factor *= (tfxOSCILLATOR_SIN(width_overlength_graph->oscillator.offset_x + width_overlength_time, width_overlength_graph->oscillator.frequency, width_overlength_graph->oscillator.amplitude) + width_overlength_graph->oscillator.offset_y);
				}
	...
	const float first_velocity_value = tfx__get_graph_first_value(&library->graphs[emitter.state_properties.graph_list_index].graphs[tfxEmitter_overtime_velocity_index]);
	const float first_weight_value = tfx__get_graph_first_value(&library->graphs[emitter.state_properties.graph_list_index].graphs[tfxEmitter_overtime_weight_index]);
	...
	const float velocity_adjuster = tfx__sample_multi_node_graph(&library->graphs[emitter.state_properties.graph_list_index].graphs[tfxEmitter_overtime_velocity_adjuster_index], emitter.age, emitter.oscillator_time);
	...
	for (int i = 0; i != entry->amount_to_spawn; ++i) {
		...
		else if (entry->root_effect_flags & tfxEffectPropertyFlags_age_order) {
			tfx_depth_index_t depth_index;
			depth_index.particle_id = tfx__make_particle_id(emitter.particles_index, index);
...
void tfx__update_ribbon_emitter_state(tfx_effect_manager pm, tfx_ribbon_emitter_state_t &ribbon, tfxU32 parent_index, const tfx_parent_spawn_controls_t *parent_spawn_controls, tfx_ribbon_work_entry_t *entry) {
	tfxPROFILE;

	tfx_library library = ribbon.library;
	tfx_shared_properties_t &properties = *entry->shared_properties;
	ribbon.bounding_box.min_corner.x = FLT_MAX;
	ribbon.bounding_box.min_corner.y = FLT_MAX;
	ribbon.bounding_box.min_corner.z = FLT_MAX;
	ribbon.bounding_box.max_corner.x = -FLT_MAX;
...
void tfx__update_emitter_state(tfx_effect_manager pm, tfx_particle_emitter_state_t &emitter, tfxU32 parent_index, const tfx_parent_spawn_controls_t *parent_spawn_controls, tfx_spawn_work_entry_t *entry) {
	tfxPROFILE;

	tfx_library library = emitter.library;
	tfx_particle_emitter_properties_t &properties = *entry->properties;
	...
	tfx_graph_t &emitter_width = library->graphs[emitter.state_properties.graph_list_index].graphs[tfxEmitter_property_width_index];
	tfx_graph_t &emitter_height = library->graphs[emitter.state_properties.graph_list_index].graphs[tfxEmitter_property_height_index];
	tfx_graph_t &emitter_depth = library->graphs[emitter.state_properties.graph_list_index].graphs[tfxEmitter_property_depth_index];
...
void tfx__update_effect_state(tfx_effect_manager pm, tfxU32 index) {
	tfxPROFILE;

	const float age = pm->effects[index].age;
	const float oscillator_time = pm->effects[index].oscillator_time;
	const tfxU32 graph_list_index = pm->effects[index].graph_list_index;
	const tfxU32 transform_index = pm->effects[index].transform_index;
...
void tfx__assign_emitter_to_gpu_group(tfx_effect_manager pm, tfx_emitter_bucket bucket) {
	if (emitter_index == tfxINVALID) return;
	tfxU32 group_index  = tfx__find_or_create_gpu_group(pm, bucket->state_properties.property_index, bucket->state_properties.max_life);
	...
	bucket->state_properties.gpu_group_index = group_index;
}
...
tfxU32 tfx__gpu_group_record_spawns(tfx_effect_manager pm, tfxIndex group_index, tfxU32 count, float current_time_ms) {
...
void tfx__control_particle_age(tfx_work_queue_t *queue, void *data) {
	...
	const tfxWideInt single_shot_limit = tfxWideSetSinglei(work_entry->shared_properties->single_shot_limit);
	const tfxU32 layer = work_entry->shared_properties->layer;
	...
	tfxU32 bump_count = 0;
	const tfxWideFloat max_life_wide = tfxWideSetSingle(emitter.state_properties.max_life);
	...
	for (int i = 0; i != work_entry->wide_end_index; i += tfxDataWidth) {
		...
		if (still_bumping) {
			...
			if (dead_mask == all_dead) {
				...
				int first_alive = (~dead_mask) & all_dead;
				bump_count += (tfxU32)tfx__scan_forward((tfx_size)first_alive);
				still_bumping = false;
			}
		}
	}
		...
		for (int i = work_entry->start_index; i >= 0; --i) {
			...
			if (flags_single_loop_count & tfxParticleFlags_remove) {
				...
				if (emitter.state_flags & tfxEmitterStateFlags_can_spin_pitch_and_yaw) {
					...
					bank.rotation_offsets[next_index] = bank.rotation_offsets[index];
				} else {
...
tfxWideFloat tfx__wide_ease_constant(tfxWideFloat t) {
...
tfxWideFloat tfx__wide_ease_in_cubic(tfxWideFloat t) {
	return tfxWideMul(tfxWideMul(t, t), t);
}

tfxWideFloat tfx__wide_ease_out_cubic(tfxWideFloat t) {
	t = tfxWideSub(tfxWIDEONE.m, t);
	return tfxWideSub(tfxWIDEONE.m, tfxWideMul(tfxWideMul(t, t), t));
}

tfxWideFloat tfx__wide_ease_in_out_cubic(tfxWideFloat t) {
	tfxWideFloat mask = tfxWideLessEqual(t, tfxWIDEHALF.m);
...
float tfx__ease_constant(float t) {
	return 0.f;
}
...
float tfx__ease_out_cubic(float t) {
	t = 1 - t;
	return 1 - (t * t * t);
}

float tfx__ease_in_out_cubic(float t) {
	float t3 = -2 * t + 2;
	t3 = t3 * t3 * t3;
...
void tfx__control_particles(tfx_work_queue_t *queue, void *data) {
	...
	if (amount_to_update > 0) {
		...
		// ---- 3d Effect Particle Positioning
		if (emitter.state_properties.control_profile & tfxEmitterControlProfile_path && (emitter.state_properties.control_profile & tfxEmitterControlProfile_edge_traversal || emitter.state_properties.property_flags & tfxEmitterPropertyFlags_use_path_as_trajectory)) {
			tfx__setup_particles_position<tfx_setup_vecolity_lookup_policy, tfx_setup_path_policy>(work_entry, ctx);
			if (emitter.state_properties.property_flags & tfxEmitterPropertyFlags_use_path_as_trajectory) {
				...
				if (emitter.library->emitter_properties[emitter.state_properties.property_index].end_behaviour == tfxLoop) {
					tfx__update_particles_position<
						tfx_apply_load_life,
						tfx_apply_lookup_velocity,
						tfx_apply_load_path,
		...
		if (emitter.state_properties.control_profile & tfxEmitterControlProfile_any_line) {
			if (emitter.state_properties.control_profile & tfxEmitterControlProfile_edge_kill && emitter.state_properties.control_profile & tfxEmitterControlProfile_edge_traversal) {
				tfx__control_particle_line_behaviour_kill(&pm->work_queue, work_entry);
			} else if (emitter.state_properties.control_profile & tfxEmitterControlProfile_edge_loop && emitter.state_properties.control_profile & tfxEmitterControlProfile_edge_traversal) {
...
void tfx__init_sprite_data_soa(tfx_soa_buffer_t *buffer, tfx_sprite_data_soa_t *soa, tfxU32 reserve_amount) {
	tfx__add_struct_array(buffer, sizeof(tfx_unique_sprite_id_t), offsetof(tfx_sprite_data_soa_t, uid));
	tfx__add_struct_array(buffer, sizeof(float), offsetof(tfx_sprite_data_soa_t, lerp_offset));
	tfx__add_struct_array(buffer, sizeof(tfx_instance_t), offsetof(tfx_sprite_data_soa_t, billboard_instance));
...
void tfx__init_particle_soa(tfx_soa_buffer_t *buffer, tfx_particle_soa_t *soa, tfxU32 reserve_amount, tfxEmitterControlProfileFlags control_profile) {
	...
	if (control_profile & tfxEmitterControlProfile_spin3d) {
		...
		tfx__add_struct_array(buffer, sizeof(float), offsetof(tfx_particle_soa_t, rotation_offset));
	}
...
tfx_effect_manager_info_t tfx_CreateEffectManagerInfo(tfx_effect_manager_setup setup) {
	...
	switch (setup) {
	case tfxEffectManagerSetup_group_sprites_by_effect:
...
void tfx__init_common_effect_manager(tfx_effect_manager pm, tfxU32 max_particles, unsigned int effects_limit, bool double_buffered_sprites, bool dynamic_sprite_allocation, bool group_sprites_by_effect, tfxU32 mt_batch_size) {
...
tfx_effect_manager tfx_CreateEffectManager(tfx_effect_manager_info_t info) {
	...
	memset(pm, 0, sizeof(tfx_effect_manager_t));
...
void tfx_ResetInstanceBufferLoopIndex(tfx_effect_manager pm) {
